//////////////////////////////////////////////////////////////////////
// 文件名称：geoProjectionConverter.cpp
// 功能描述：地理坐标转换工具
// 创建标识：吕伟	2022/11/2
// 修改标识：
// 修改描述：
...
static const ReferenceEllipsoid ellipsoid_list[] = {
	...
	ReferenceEllipsoid(-1,
					   "Placeholder",
					   0,
					   0,
					   0), // placeholder to allow array indices to match id numbers
	...
	ReferenceEllipsoid(24,
					   "Indonesian National 1974",
					   6378160,
					   0.0066946091071419115,
					   298.2469988070381)
};
...
static const short PCS_NAD83_Alaska_zone_1 =
	26931; /* Hotine Oblique Mercator Projection not supported*/
...
static const StatePlaneLCC state_plane_lcc_nad27_list[] = {
	// zone, false east [m], false north [m], ProjOrig(Lat), CentMerid(Long), 1st std para, 2nd std
	// para
	StatePlaneLCC(PCS_NAD27_Alaska_zone_10,
				  ...
				  51.83333333,
				  53.83333333),
	StatePlaneLCC(PCS_NAD27_Arkansas_North,
				  "AR_N",
				  609601.2192,
				  0,
				  34.33333333,
				  ...
				  34.93333333,
				  36.23333333),
	StatePlaneLCC(PCS_NAD27_Arkansas_South,
				  "AR_S",
				  609601.2192,
				  0,
				  32.66666667,
				  ...
				  33.3,
				  34.76666667),
	StatePlaneLCC(PCS_NAD27_California_I,
				  "CA_I",
				  609601.2192,
				  0,
				  39.33333333,
				  ...
				  40,
				  41.66666667),
	StatePlaneLCC(PCS_NAD27_California_II,
				  "CA_II",
				  609601.2192,
				  0,
				  37.66666667,
	...
	StatePlaneLCC(PCS_NAD27_California_V,
				  "CA_V",
				  609601.2192,
				  0,
				  33.5,
				  ...
				  34.03333333,
				  35.46666667),
	StatePlaneLCC(PCS_NAD27_California_VI,
				  "CA_VI",
				  609601.2192,
				  0,
				  32.16666667,
				  ...
				  32.78333333,
				  33.88333333),
	StatePlaneLCC(PCS_NAD27_California_VII,
				  "CA_VII",
				  1276106.451,
				  1268253.007,
				  34.13333333,
				  ...
				  33.86666667,
				  34.41666667),
	StatePlaneLCC(PCS_NAD27_Colorado_North,
				  "CO_N",
				  609601.2192,
				  0,
				  39.33333333,
				  ...
				  39.71666667,
				  40.78333333),
	StatePlaneLCC(PCS_NAD27_Colorado_Central,
				  "CO_C",
				  609601.2192,
				  0,
				  37.83333333,
				  ...
				  38.45,
				  39.75),
	StatePlaneLCC(PCS_NAD27_Colorado_South,
				  "CO_S",
				  609601.2192,
				  0,
				  36.66666667,
				  ...
				  37.23333333,
				  38.43333333),
	StatePlaneLCC(PCS_NAD27_Connecticut,
				  "CT",
				  182880.3658,
				  0,
				  40.83333333,
	...
	StatePlaneLCC(PCS_NAD27_Iowa_North,
				  "IA_N",
				  609601.2192,
				  0,
				  41.5,
				  ...
				  42.06666667,
				  43.26666667),
	StatePlaneLCC(PCS_NAD27_Iowa_South,
				  "IA_S",
				  609601.2192,
				  0,
				  40,
				  ...
				  40.61666667,
				  41.78333333),
	StatePlaneLCC(PCS_NAD27_Kansas_North,
				  "KS_N",
				  609601.2192,
				  0,
				  38.33333333,
				  ...
				  38.71666667,
				  39.78333333),
	StatePlaneLCC(PCS_NAD27_Kansas_South,
				  "KS_S",
				  609601.2192,
				  0,
				  36.66666667,
				  ...
				  37.26666667,
				  38.56666667),
	StatePlaneLCC(PCS_NAD27_Kentucky_North,
				  "KY_N",
				  609601.2192,
				  0,
				  37.5,
				  ...
				  37.96666667,
				  38.96666667),
	StatePlaneLCC(PCS_NAD27_Kentucky_South,
				  "KY_S",
				  609601.2192,
				  0,
				  36.33333333,
				  ...
				  36.73333333,
				  37.93333333),
	StatePlaneLCC(PCS_NAD27_Louisiana_North,
				  "LA_N",
				  609601.2192,
				  0,
				  30.66666667,
				  ...
				  31.16666667,
				  32.66666667),
	StatePlaneLCC(PCS_NAD27_Louisiana_South,
				  "LA_S",
				  609601.2192,
				  0,
				  28.66666667,
	...
	StatePlaneLCC(PCS_NAD27_Massachusetts,
				  "MA_M",
				  182880.3658,
				  0,
				  41,
				  ...
				  41.71666667,
				  42.68333333),
	StatePlaneLCC(PCS_NAD27_Massachusetts_Is,
				  "MA_I",
				  60960.12192,
				  0,
				  41,
				  ...
				  41.28333333,
				  41.48333333),
	StatePlaneLCC(PCS_NAD27_Michigan_North,
				  "MI_N",
				  609601.2192,
				  0,
				  44.78333333,
				  ...
				  45.48333333,
				  47.08333333),
	StatePlaneLCC(PCS_NAD27_Michigan_Central,
				  "MI_C",
				  609601.2192,
				  0,
				  43.31666667,
				  ...
				  44.18333333,
				  45.7),
	StatePlaneLCC(PCS_NAD27_Michigan_South,
				  "MI_S",
				  609601.2192,
				  0,
				  41.5,
				  ...
				  42.1,
				  43.66666667),
	StatePlaneLCC(PCS_NAD27_Minnesota_North,
				  "MN_N",
				  609601.2192,
				  0,
				  46.5,
				  ...
				  47.03333333,
				  48.63333333),
	StatePlaneLCC(PCS_NAD27_Minnesota_Central,
				  "MN_C",
				  609601.2192,
				  0,
				  45,
				  ...
				  45.61666667,
				  47.05),
	StatePlaneLCC(PCS_NAD27_Minnesota_South,
				  "MN_S",
				  609601.2192,
				  0,
				  43,
	...
	StatePlaneLCC(PCS_NAD27_Montana_Central,
				  "MT_C",
				  609601.2192,
				  0,
				  45.83333333,
	...
	StatePlaneLCC(PCS_NAD27_Nebraska_North,
				  "NE_N",
				  609601.2192,
				  0,
				  41.33333333,
				  ...
				  41.85,
				  42.81666667),
	StatePlaneLCC(PCS_NAD27_Nebraska_South,
				  "NE_S",
				  609601.2192,
				  0,
				  39.66666667,
				  ...
				  40.28333333,
				  41.71666667),
	StatePlaneLCC(PCS_NAD27_New_York_Long_Is,
				  "NY_LI",
				  609601.2192,
				  30480.06096,
				  40.5,
				  ...
				  40.66666667,
				  41.03333333),
	StatePlaneLCC(PCS_NAD27_North_Carolina,
				  "NC",
				  609601.2192,
				  0,
				  33.75,
				  ...
				  34.33333333,
				  36.16666667),
	StatePlaneLCC(PCS_NAD27_North_Dakota_N,
				  "ND_N",
				  609601.2192,
				  0,
				  47,
				  ...
				  47.43333333,
				  48.73333333),
	StatePlaneLCC(PCS_NAD27_North_Dakota_S,
				  "ND_S",
				  609601.2192,
				  0,
				  45.66666667,
				  ...
				  46.18333333,
				  47.48333333),
	StatePlaneLCC(PCS_NAD27_Ohio_North,
				  "OH_N",
				  609601.2192,
				  0,
				  39.66666667,
				  ...
				  40.43333333,
				  41.7),
	StatePlaneLCC(PCS_NAD27_Ohio_South,
				  "OH_S",
				  609601.2192,
				  0,
				  38,
				  ...
				  38.73333333,
				  40.03333333),
	StatePlaneLCC(PCS_NAD27_Oklahoma_North,
				  "OK_N",
				  609601.2192,
				  0,
				  35,
				  ...
				  35.56666667,
				  36.76666667),
	StatePlaneLCC(PCS_NAD27_Oklahoma_South,
				  "OK_S",
				  609601.2192,
				  0,
				  33.33333333,
				  ...
				  33.93333333,
				  35.23333333),
	StatePlaneLCC(PCS_NAD27_Oregon_North,
				  "OR_N",
				  609601.2192,
				  0,
				  43.66666667,
				  ...
				  44.33333333,
				  46),
	StatePlaneLCC(PCS_NAD27_Oregon_South,
				  "OR_S",
				  609601.2192,
				  0,
				  41.66666667,
				  ...
				  42.33333333,
				  44),
	StatePlaneLCC(PCS_NAD27_Pennsylvania_N,
				  "PA_N",
				  609601.2192,
				  0,
				  40.16666667,
				  ...
				  40.88333333,
				  41.95),
	StatePlaneLCC(PCS_NAD27_Pennsylvania_S,
				  "PA_S",
				  609601.2192,
				  0,
				  39.33333333,
				  ...
				  39.93333333,
				  40.96666667),
	StatePlaneLCC(PCS_NAD27_Puerto_Rico,
				  "PR",
				  152400.3048,
				  0,
				  17.83333333,
				  ...
				  18.03333333,
				  18.43333333),
	StatePlaneLCC(PCS_NAD27_St_Croix,
				  "St.Croix",
				  152400.3048,
				  30480.06096,
				  17.83333333,
				  ...
				  18.03333333,
				  18.43333333),
	StatePlaneLCC(PCS_NAD27_South_Carolina_N,
				  "SC_N",
				  609601.2192,
				  0,
				  33,
				  ...
				  33.76666667,
				  34.96666667),
	StatePlaneLCC(PCS_NAD27_South_Carolina_S,
				  "SC_S",
				  609601.2192,
				  0,
				  31.83333333,
				  ...
				  32.33333333,
				  33.66666667),
	StatePlaneLCC(PCS_NAD27_South_Dakota_N,
				  "SD_N",
				  609601.2192,
				  0,
				  43.83333333,
				  ...
				  44.41666667,
				  45.68333333),
	StatePlaneLCC(PCS_NAD27_South_Dakota_S,
				  "SD_S",
				  609601.2192,
				  0,
				  42.33333333,
				  ...
				  42.83333333,
				  44.4),
	StatePlaneLCC(PCS_NAD27_Tennessee,
				  "TN",
				  609601.2192,
				  30480.06096,
				  34.66666667,
	...
	StatePlaneLCC(PCS_NAD27_Texas_North_Central,
				  "TX_NC",
				  609601.2192,
				  0,
				  31.66666667,
				  ...
				  32.13333333,
				  33.96666667),
	StatePlaneLCC(PCS_NAD27_Texas_Central,
				  "TX_C",
				  609601.2192,
				  0,
				  29.66666667,
				  ...
				  30.11666667,
				  31.88333333),
	StatePlaneLCC(PCS_NAD27_Texas_South_Central,
				  "TX_SC",
				  609601.2192,
				  0,
				  27.83333333,
				  ...
				  28.38333333,
				  30.28333333),
	StatePlaneLCC(PCS_NAD27_Texas_South,
				  "TX_S",
				  609601.2192,
				  0,
				  25.66666667,
				  ...
				  26.16666667,
				  27.83333333),
	StatePlaneLCC(PCS_NAD27_Utah_North,
				  "UT_N",
				  609601.2192,
				  0,
				  40.33333333,
				  ...
				  40.71666667,
				  41.78333333),
	StatePlaneLCC(PCS_NAD27_Utah_Central,
				  "UT_C",
				  609601.2192,
				  0,
				  38.33333333,
				  ...
				  39.01666667,
				  40.65),
	StatePlaneLCC(PCS_NAD27_Utah_South,
				  "UT_S",
				  609601.2192,
				  0,
				  36.66666667,
				  ...
				  37.21666667,
				  38.35),
	StatePlaneLCC(PCS_NAD27_Virginia_North,
				  "VA_N",
				  609601.2192,
				  0,
				  37.66666667,
				  ...
				  38.03333333,
				  39.2),
	StatePlaneLCC(PCS_NAD27_Virginia_South,
				  "VA_S",
				  609601.2192,
				  0,
				  36.33333333,
				  ...
				  36.76666667,
				  37.96666667),
	StatePlaneLCC(PCS_NAD27_Washington_North,
				  "WA_N",
				  609601.2192,
				  0,
				  47,
				  ...
				  47.5,
				  48.73333333),
	StatePlaneLCC(PCS_NAD27_Washington_South,
				  "WA_S",
				  609601.2192,
				  0,
				  45.33333333,
	...
	StatePlaneLCC(PCS_NAD27_West_Virginia_S,
				  "WV_S",
				  609601.2192,
				  0,
				  37,
				  ...
				  37.48333333,
				  38.88333333),
	StatePlaneLCC(PCS_NAD27_Wisconsin_North,
				  "WI_N",
				  609601.2192,
				  0,
				  45.16666667,
				  ...
				  45.56666667,
				  46.76666667),
	StatePlaneLCC(PCS_NAD27_Wisconsin_Central,
				  "WI_C",
				  609601.2192,
				  0,
				  43.83333333,
				  ...
				  44.25,
				  45.5),
	StatePlaneLCC(PCS_NAD27_Wisconsin_South,
				  "WI_S",
				  609601.2192,
				  0,
				  42,
...
static const StatePlaneLCC state_plane_lcc_nad83_list[] = {
	// geotiff key, zone, false east [m], false north [m], ProjOrig(Lat), CentMerid(Long), 1st std
	// para, 2nd std para
	StatePlaneLCC(PCS_NAD83_Alaska_zone_10,
				  ...
				  51.833333,
				  53.833333),
	StatePlaneLCC(PCS_NAD83_Arkansas_North,
				  "AR_N",
				  400000,
				  0,
				  34.333333,
				  ...
				  34.933333,
				  36.233333),
	StatePlaneLCC(PCS_NAD83_Arkansas_South,
				  "AR_S",
				  400000,
				  400000,
				  32.666667,
				  ...
				  33.300000,
				  34.766667),
	StatePlaneLCC(PCS_NAD83_California_1,
				  "CA_I",
				  2000000,
				  500000,
				  39.333333,
				  ...
				  40.000000,
				  41.666667),
	StatePlaneLCC(PCS_NAD83_California_2,
				  "CA_II",
				  2000000,
				  500000,
				  37.666667,
				  ...
				  38.333333,
				  39.833333),
	StatePlaneLCC(PCS_NAD83_California_3,
				  "CA_III",
				  2000000,
				  500000,
				  36.500000,
				  ...
				  37.066667,
				  38.433333),
	StatePlaneLCC(PCS_NAD83_California_4,
				  "CA_IV",
				  2000000,
				  500000,
				  35.333333,
				  ...
				  36.000000,
				  37.250000),
	StatePlaneLCC(PCS_NAD83_California_5,
				  "CA_V",
				  2000000,
				  500000,
				  33.500000,
				  ...
				  34.033333,
				  35.466667),
	StatePlaneLCC(PCS_NAD83_California_6,
				  "CA_VI",
				  2000000,
				  500000,
				  32.166667,
				  ...
				  32.783333,
				  33.883333),
	StatePlaneLCC(PCS_NAD83_Colorado_North,
				  "CO_N",
				  914401.8289,
				  304800.6096,
				  39.333333,
				  ...
				  39.716667,
				  40.783333),
	StatePlaneLCC(PCS_NAD83_Colorado_Central,
				  "CO_C",
				  914401.8289,
				  304800.6096,
				  37.833333,
				  ...
				  38.450000,
				  39.750000),
	StatePlaneLCC(PCS_NAD83_Colorado_South,
				  "CO_S",
				  914401.8289,
				  304800.6096,
				  36.666667,
				  ...
				  37.233333,
				  38.433333),
	StatePlaneLCC(PCS_NAD83_Connecticut,
				  "CT",
				  304800.6096,
				  152400.3048,
				  40.833333,
				  ...
				  41.200000,
				  41.866667),
	StatePlaneLCC(PCS_NAD83_Florida_North,
				  "FL_N",
				  600000,
				  0,
				  29.000000,
				  ...
				  29.583333,
				  30.750000),
	StatePlaneLCC(PCS_NAD83_Iowa_North,
				  "IA_N",
				  1500000,
				  1000000,
				  41.500000,
				  ...
				  42.066667,
				  43.266667),
	StatePlaneLCC(PCS_NAD83_Iowa_South,
				  "IA_S",
				  500000,
				  0,
				  40.000000,
				  ...
				  40.616667,
				  41.783333),
	StatePlaneLCC(PCS_NAD83_Kansas_North,
				  "KS_N",
				  400000,
				  0,
				  38.333333,
				  ...
				  38.716667,
				  39.783333),
	StatePlaneLCC(PCS_NAD83_Kansas_South,
				  "KS_S",
				  400000,
				  400000,
				  36.666667,
				  ...
				  37.266667,
				  38.566667),
	StatePlaneLCC(PCS_NAD83_Kentucky_North,
				  "KY_N",
				  500000,
				  0,
				  37.500000,
				  ...
				  37.966667,
				  38.966667),
	StatePlaneLCC(PCS_NAD83_Kentucky_South,
				  "KY_S",
				  500000,
				  500000,
				  36.333333,
				  ...
				  36.733333,
				  37.933333),
	StatePlaneLCC(PCS_NAD83_Louisiana_North,
				  "LA_N",
				  1000000,
				  0,
				  30.500000,
				  ...
				  31.166667,
				  32.666667),
	StatePlaneLCC(PCS_NAD83_Louisiana_South,
				  "LA_S",
				  1000000,
				  0,
				  28.500000,
	...
	StatePlaneLCC(PCS_NAD83_Massachusetts,
				  "MA_M",
				  200000,
				  750000,
				  41.000000,
				  ...
				  41.716667,
				  42.683333),
	StatePlaneLCC(PCS_NAD83_Massachusetts_Is,
				  "MA_I",
				  500000,
				  0,
				  41.000000,
				  ...
				  41.283333,
				  41.483333),
	StatePlaneLCC(PCS_NAD83_Michigan_North,
				  "MI_N",
				  8000000,
				  0,
				  44.783333,
				  ...
				  45.483333,
				  47.083333),
	StatePlaneLCC(PCS_NAD83_Michigan_Central,
				  "MI_C",
				  6000000,
				  0,
				  43.316667,
				  ...
				  44.183333,
				  45.700000),
	StatePlaneLCC(PCS_NAD83_Michigan_South,
				  "MI_S",
				  4000000,
				  0,
				  41.500000,
				  ...
				  42.100000,
				  43.666667),
	StatePlaneLCC(PCS_NAD83_Minnesota_North,
				  "MN_N",
				  800000,
				  100000,
				  46.500000,
				  ...
				  47.033333,
				  48.633333),
	StatePlaneLCC(PCS_NAD83_Minnesota_Central,
				  "MN_C",
				  800000,
				  100000,
				  45.000000,
				  ...
				  45.616667,
				  47.050000),
	StatePlaneLCC(PCS_NAD83_Minnesota_South,
				  "MN_S",
				  800000,
				  100000,
				  43.000000,
	...
	StatePlaneLCC(PCS_NAD83_Nebraska,
				  "NE",
				  500000,
				  0,
				  39.833333,
				  ...
				  40.000000,
				  43.000000),
	StatePlaneLCC(PCS_NAD83_New_York_Long_Is,
				  "NY_LI",
				  300000,
				  0,
				  40.166667,
				  ...
				  40.666667,
				  41.033333),
	StatePlaneLCC(PCS_NAD83_North_Carolina,
				  "NC",
				  609601.22,
				  0,
				  33.750000,
				  ...
				  34.333333,
				  36.166667),
	StatePlaneLCC(PCS_NAD83_North_Dakota_N,
				  "ND_N",
				  600000,
				  0,
				  47.000000,
				  ...
				  47.433333,
				  48.733333),
	StatePlaneLCC(PCS_NAD83_North_Dakota_S,
				  "ND_S",
				  600000,
				  0,
				  45.666667,
				  ...
				  46.183333,
				  47.483333),
	StatePlaneLCC(PCS_NAD83_Ohio_North,
				  "OH_N",
				  600000,
				  0,
				  39.666667,
				  ...
				  40.433333,
				  41.700000),
	StatePlaneLCC(PCS_NAD83_Ohio_South,
				  "OH_S",
				  600000,
				  0,
				  38.000000,
				  ...
				  38.733333,
				  40.033333),
	StatePlaneLCC(PCS_NAD83_Oklahoma_North,
				  "OK_N",
				  600000,
				  0,
				  35.000000,
				  ...
				  35.566667,
				  36.766667),
	StatePlaneLCC(PCS_NAD83_Oklahoma_South,
				  "OK_S",
				  600000,
				  0,
				  33.333333,
				  ...
				  33.933333,
				  35.233333),
	StatePlaneLCC(PCS_NAD83_Oregon_North,
				  "OR_N",
				  2500000,
				  0,
				  43.666667,
				  ...
				  44.333333,
				  46.000000),
	StatePlaneLCC(PCS_NAD83_Oregon_South,
				  "OR_S",
				  1500000,
				  0,
				  41.666667,
				  ...
				  42.333333,
				  44.000000),
	StatePlaneLCC(PCS_NAD83_Pennsylvania_N,
				  "PA_N",
				  600000,
				  0,
				  40.166667,
				  ...
				  40.883333,
				  41.950000),
	StatePlaneLCC(PCS_NAD83_Pennsylvania_S,
				  "PA_S",
				  600000,
				  0,
				  39.333333,
				  ...
				  39.933333,
				  40.966667),
	StatePlaneLCC(PCS_NAD83_Puerto_Rico,
				  "PR",
				  200000,
				  200000,
				  17.833333,
				  ...
				  18.033333,
				  18.433333),
	StatePlaneLCC(PCS_NAD83_South_Carolina,
				  "SC",
				  609600,
				  0,
				  31.833333,
				  ...
				  32.500000,
				  34.833333),
	StatePlaneLCC(PCS_NAD83_South_Dakota_N,
				  "SD_N",
				  600000,
				  0,
				  43.833333,
				  ...
				  44.416667,
				  45.683333),
	StatePlaneLCC(PCS_NAD83_South_Dakota_S,
				  "SD_S",
				  600000,
				  0,
				  42.333333,
				  ...
				  42.833333,
				  44.400000),
	StatePlaneLCC(PCS_NAD83_Tennessee,
				  "TN",
				  600000,
				  0,
				  34.333333,
				  ...
				  35.250000,
				  36.416667),
	StatePlaneLCC(PCS_NAD83_Texas_North,
				  "TX_N",
				  200000,
				  1000000,
				  34.000000,
				  ...
				  34.650000,
				  36.183333),
	StatePlaneLCC(PCS_NAD83_Texas_North_Central,
				  "TX_NC",
				  600000,
				  2000000,
				  31.666667,
				  ...
				  32.133333,
				  33.966667),
	StatePlaneLCC(PCS_NAD83_Texas_Central,
				  "TX_C",
				  700000,
				  3000000,
				  29.666667,
				  ...
				  30.116667,
				  31.883333),
	StatePlaneLCC(PCS_NAD83_Texas_South_Central,
				  "TX_SC",
				  600000,
				  4000000,
				  27.833333,
				  ...
				  28.383333,
				  30.283333),
	StatePlaneLCC(PCS_NAD83_Texas_South,
				  "TX_S",
				  300000,
				  5000000,
				  25.666667,
				  ...
				  26.166667,
				  27.833333),
	StatePlaneLCC(PCS_NAD83_Utah_North,
				  "UT_N",
				  500000,
				  1000000,
				  40.333333,
				  ...
				  40.716667,
				  41.783333),
	StatePlaneLCC(PCS_NAD83_Utah_Central,
				  "UT_C",
				  500000,
				  2000000,
				  38.333333,
				  ...
				  39.016667,
				  40.650000),
	StatePlaneLCC(PCS_NAD83_Utah_South,
				  "UT_S",
				  500000,
				  3000000,
				  36.666667,
				  ...
				  37.216667,
				  38.350000),
	StatePlaneLCC(PCS_NAD83_Virginia_North,
				  "VA_N",
				  3500000,
				  2000000,
				  37.666667,
				  ...
				  38.033333,
				  39.200000),
	StatePlaneLCC(PCS_NAD83_Virginia_South,
				  "VA_S",
				  3500000,
				  1000000,
				  36.333333,
				  ...
				  36.766667,
				  37.966667),
	StatePlaneLCC(PCS_NAD83_Washington_North,
				  "WA_N",
				  500000,
				  0,
				  47.000000,
				  ...
				  47.500000,
				  48.733333),
	StatePlaneLCC(PCS_NAD83_Washington_South,
				  "WA_S",
				  500000,
				  0,
				  45.333333,
				  ...
				  45.833333,
				  47.333333),
	StatePlaneLCC(PCS_NAD83_West_Virginia_N,
				  "WV_N",
				  600000,
				  0,
				  38.500000,
				  ...
				  39.000000,
				  40.250000),
	StatePlaneLCC(PCS_NAD83_West_Virginia_S,
				  "WV_S",
				  600000,
				  0,
				  37.000000,
				  ...
				  37.483333,
				  38.883333),
	StatePlaneLCC(PCS_NAD83_Wisconsin_North,
				  "WI_N",
				  600000,
				  0,
				  45.166667,
				  ...
				  45.566667,
				  46.766667),
	StatePlaneLCC(PCS_NAD83_Wisconsin_Central,
				  "WI_C",
				  600000,
				  0,
				  43.833333,
				  ...
				  44.250000,
				  45.500000),
	StatePlaneLCC(PCS_NAD83_Wisconsin_South,
				  "WI_S",
				  600000,
				  0,
				  42.000000,
...
static const StatePlaneTM state_plane_tm_nad27_list[] = {
	// geotiff key, zone, false east [m], false north [m], ProjOrig(Lat), CentMerid(Long), scale
	// factor
	...
	StatePlaneTM(PCS_NAD27_Hawaii_zone_2,
				 "HI_2",
				 152400.3048,
				 0,
				 20.33333333,
	...
	StatePlaneTM(PCS_NAD27_Idaho_East,
				 "ID_E",
				 152400.3048,
				 0,
				 41.66666667,
	...
	StatePlaneTM(PCS_NAD27_Illinois_East,
				 "IL_E",
				 152400.3048,
				 0,
				 36.66666667,
				 -88.33333333,
				 0.999975),
	StatePlaneTM(PCS_NAD27_Illinois_West,
				 "IL_W",
				 152400.3048,
				 0,
				 36.66666667,
	...
	StatePlaneTM(PCS_NAD27_Maine_West,
				 "ME_W",
				 152400.3048,
				 0,
				 42.83333333,
				 -70.16666667,
				 0.999966667),
	StatePlaneTM(PCS_NAD27_Mississippi_East,
				 "MS_E",
				 152400.3048,
				 0,
				 29.66666667,
				 -88.83333333,
				 0.99996),
	StatePlaneTM(PCS_NAD27_Mississippi_West,
				 "MS_W",
				 152400.3048,
				 0,
				 30.5,
	...
	StatePlaneTM(PCS_NAD27_Missouri_Central,
				 "MO_C",
				 152400.3048,
				 0,
				 35.83333333,
	...
	StatePlaneTM(PCS_NAD27_Wyoming_East,
				 "WY_E",
				 152400.3048,
				 0,
				 40.66666667,
				 -105.1666667,
				 0.999941177),
	StatePlaneTM(PCS_NAD27_Wyoming_East_Central,
				 "WY_EC",
				 152400.3048,
				 0,
				 40.66666667,
				 -107.3333333,
				 0.999941177),
	StatePlaneTM(PCS_NAD27_Wyoming_West_Central,
				 "WY_WC",
				 152400.3048,
				 0,
				 40.66666667,
				 -108.75,
				 0.999941177),
	StatePlaneTM(PCS_NAD27_Wyoming_West,
				 "WY_W",
				 152400.3048,
				 0,
				 40.66666667,
...
static const StatePlaneTM state_plane_tm_nad83_list[] = {
	...
	StatePlaneTM(PCS_NAD83_Hawaii_zone_2,
				 "HI_2",
				 500000,
				 0,
				 20.33333333,
	...
	StatePlaneTM(PCS_NAD83_Illinois_West,
				 "IL_W",
				 700000,
				 0,
				 36.66666667,
	...
	StatePlaneTM(PCS_NAD83_Wyoming_East_Central,
				 "WY_EC",
				 400000,
				 100000,
				 40.5,
...
bool GeoProjectionConverter::set_projection_from_geo_keys(int num_geo_keys,
														  ...
														  bool source)
{
	...
	for (int i = 0; i < num_geo_keys; i++)
	{
		...
		case 3072: // ProjectedCSTypeGeoKey
			has_projection =
				set_ProjectedCSTypeGeoKey(geo_keys[i].value_offset, description, source);
			break;
		...
		case 2048: // GeographicTypeGeoKey
			...
			case 4009: // GCSE_Clarke1866Michigan (unknown datum based on Clarke1866Michigan
					   // ellipsoid)
			...
			default:
				fprintf(stderr,
						"GeographicTypeGeoKey: look-up for %d not implemented\n",
		...
		case 2050: // GeogGeodeticDatumGeoKey
			...
			default:
				fprintf(stderr,
						"GeogGeodeticDatumGeoKey: look-up for %d not implemented\n",
						geo_keys[i].value_offset);
			}
			break;
		case 2052: // GeogLinearUnitsGeoKey
			...
			default:
				fprintf(stderr,
						"GeogLinearUnitsGeoKey: look-up for %d not implemented\n",
						geo_keys[i].value_offset);
			}
			break;
		...
		case 3075: // ProjCoordTransGeoKey
			...
			case 2: // CT_TransvMercator_Modified_Alaska
				fprintf(
					stderr,
					"ProjCoordTransGeoKey: CT_TransvMercator_Modified_Alaska not implemented\n");
				break;
			...
			case 4: // CT_ObliqueMercator_Laborde
				fprintf(stderr,
						"ProjCoordTransGeoKey: CT_ObliqueMercator_Laborde not implemented\n");
				break;
			case 5: // CT_ObliqueMercator_Rosenmund
				fprintf(stderr,
						"ProjCoordTransGeoKey: CT_ObliqueMercator_Rosenmund not implemented\n");
				break;
			case 6: // CT_ObliqueMercator_Spherical
				fprintf(stderr,
						"ProjCoordTransGeoKey: CT_ObliqueMercator_Spherical not implemented\n");
				break;
			case 7: // CT_Mercator
			...
			case 9: // CT_LambertConfConic_Helmert
				fprintf(stderr,
						"ProjCoordTransGeoKey: CT_LambertConfConic_Helmert not implemented\n");
				break;
			...
			case 27: // CT_TransvMercator_SouthOriented
				fprintf(stderr,
						"ProjCoordTransGeoKey: CT_TransvMercator_SouthOriented not implemented\n");
				break;
			default:
				fprintf(stderr,
						"ProjCoordTransGeoKey: look-up for %d not implemented\n",
						geo_keys[i].value_offset);
			}
			break;
	...
	if (user_defined_projection)
	{
		...
		{
			if ((offsetProjFalseEastingGeoKey >= 0) && (offsetProjFalseNorthingGeoKey >= 0) &&
				(offsetProjNatOriginLatGeoKey >= 0) && (offsetProjCenterLongGeoKey >= 0) &&
		...
		else if (user_defined_projection == 8)
		{
			if (((offsetProjFalseEastingGeoKey >= 0) ||
				 (offsetProjFalseOriginEastingGeoKey >= 0)) &&
				((offsetProjFalseNorthingGeoKey >= 0) ||
				 (offsetProjFalseOriginNorthingGeoKey >= 0)) &&
				...
				((offsetProjCenterLongGeoKey >= 0) || (offsetProjNatOriginLongGeoKey >= 0) ||
				 (offsetProjFalseOriginLongGeoKey >= 0)) &&
				(offsetProjStdParallel1GeoKey >= 0) && (offsetProjStdParallel2GeoKey >= 0))
			{
				double falseEastingMeter =
					((offsetProjFalseEastingGeoKey >= 0)
						 ? geo_double_params[offsetProjFalseEastingGeoKey] * coordinates2meter
						 : geo_double_params[offsetProjFalseOriginEastingGeoKey] *
							   coordinates2meter);
				double falseNorthingMeter =
					((offsetProjFalseNorthingGeoKey >= 0)
						 ? geo_double_params[offsetProjFalseNorthingGeoKey] * coordinates2meter
						 : geo_double_params[offsetProjFalseOriginNorthingGeoKey] *
							   coordinates2meter);
				double latOriginDeg = ((offsetProjNatOriginLatGeoKey >= 0)
										   ? geo_double_params[offsetProjNatOriginLatGeoKey]
										   : geo_double_params[offsetProjFalseOriginLatGeoKey]);
				double longOriginDeg =
					((offsetProjCenterLongGeoKey >= 0)
						 ? geo_double_params[offsetProjCenterLongGeoKey]
						 : ((offsetProjNatOriginLongGeoKey >= 0)
								? geo_double_params[offsetProjNatOriginLongGeoKey]
								: geo_double_params[offsetProjFalseOriginLongGeoKey]));
				if ((longOriginDeg == 0.0) && (offsetProjNatOriginLongGeoKey >= 0))
					longOriginDeg = geo_double_params[offsetProjNatOriginLongGeoKey];
		...
		else if (user_defined_projection == 11)
		{
				...
				(offsetProjStdParallel1GeoKey >= 0) && (offsetProjStdParallel2GeoKey >= 0))
			{
				...
				double falseNorthingMeter =
					geo_double_params[offsetProjFalseNorthingGeoKey] * coordinates2meter;
				double latOriginDeg = geo_double_params[offsetProjNatOriginLatGeoKey];
				double longOriginDeg = ((offsetProjCenterLongGeoKey >= 0)
											? geo_double_params[offsetProjCenterLongGeoKey]
											: geo_double_params[offsetProjNatOriginLongGeoKey]);
				if ((longOriginDeg == 0.0) && (offsetProjNatOriginLongGeoKey >= 0))
					longOriginDeg = geo_double_params[offsetProjNatOriginLongGeoKey];
				double firstStdParallelDeg = geo_double_params[offsetProjStdParallel1GeoKey];
				double secondStdParallelDeg = geo_double_params[offsetProjStdParallel2GeoKey];
				set_albers_equal_area_conic_projection(falseEastingMeter,
													   falseNorthingMeter,
													   latOriginDeg,
													   longOriginDeg,
													   firstStdParallelDeg,
		...
		else if (user_defined_projection == 16)
		{
				...
				(offsetProjScaleAtNatOriginGeoKey >= 0))
			{
				...
				double falseNorthingMeter =
					geo_double_params[offsetProjFalseNorthingGeoKey] * coordinates2meter;
				double latOriginDeg = geo_double_params[offsetProjNatOriginLatGeoKey];
				double longMeridianDeg = ((offsetProjCenterLongGeoKey >= 0)
											  ? geo_double_params[offsetProjCenterLongGeoKey]
											  : geo_double_params[offsetProjNatOriginLongGeoKey]);
				double scaleFactor = geo_double_params[offsetProjScaleAtNatOriginGeoKey];
				set_oblique_stereographic_projection(falseEastingMeter,
													 falseNorthingMeter,
													 latOriginDeg,
													 longMeridianDeg,
													 scaleFactor,
		...
		{
			if ((offsetProjFalseEastingGeoKey >= 0) && (offsetProjFalseNorthingGeoKey >= 0) &&
				(offsetProjCenterLatGeoKey >= 0) && (offsetProjCenterLongGeoKey >= 0) &&
				(offsetProjAzimuthAngleGeoKey >= 0) && (offsetProjScaleAtCenterGeoKey >= 0))
			{
				double falseEastingMeter =
					geo_double_params[offsetProjFalseEastingGeoKey] * coordinates2meter;
				double falseNorthingMeter =
				...
				double rectifiedGridAngleDeg =
					(offsetProjRectifiedGridAngleGeoKey >= 0
						 ? geo_double_params[offsetProjRectifiedGridAngleGeoKey]
						 : azimuthDeg);
				double scaleFactor = geo_double_params[offsetProjScaleAtCenterGeoKey];
				set_hotine_oblique_mercator_projection(falseEastingMeter,
													   falseNorthingMeter,
													   latCenterDeg,
													   longCenterDeg,
													   azimuthDeg,
													   rectifiedGridAngleDeg,
													   scaleFactor,
													   0,
													   source);
				if (description)
...
bool GeoProjectionConverter::get_geo_keys_from_projection(int& num_geo_keys,
														  ...
														  bool source)
{
	...
	if (projection)
	{
		...
		if (projection->type == GEO_PROJECTION_UTM || projection->type == GEO_PROJECTION_LCC ||
			projection->type == GEO_PROJECTION_TM || projection->type == GEO_PROJECTION_AEAC ||
			projection->type == GEO_PROJECTION_HOM || projection->type == GEO_PROJECTION_OS)
		{
			...
			if (geokey && geokey != 32767)
			{
				...
				(*geo_keys) =
					(GeoProjectionGeoKeys*)malloc(sizeof(GeoProjectionGeoKeys) * num_geo_keys);
				(*geo_double_params) = 0;
			...
			else
			{
				fprintf(stderr,
				 ...
				 projection->type == GEO_PROJECTION_LONG_LAT)
		{
...
#define MAX_PATH 1024
...
#else
	// Linux替代GetModuleFileNameA: 获取可执行文件路径
	ssize_t len = readlink("/proc/self/exe", path, MAX_GEO_PATH_LENGTH - 1);
	if (len == -1)
	{
		// 如果读取失败，使用当前工作目录
		if (getcwd(path, MAX_GEO_PATH_LENGTH) == nullptr)
		{
			strcpy(path, ".");
		}
	}
	...
	// Linux替代PathRemoveFileSpecA: 移除文件名部分，获取目录
	// 注意：dirname可能会修改传入的字符串，所以使用副本
	char exe_path_copy[MAX_GEO_PATH_LENGTH];
	strncpy(exe_path_copy, path, MAX_GEO_PATH_LENGTH - 1);
	exe_path_copy[MAX_GEO_PATH_LENGTH - 1] = '\0';

	char* dir = dirname(exe_path_copy);
	if (dir != nullptr)
	{
		strncpy(path, dir, MAX_GEO_PATH_LENGTH - 1);
		path[MAX_GEO_PATH_LENGTH - 1] = '\0';
	}
	else
	{
		strcpy(path, ".");
...
#endif
	std::string filepath = std::string(path) + R"(\system\gdal_data\)";


	if (vertical)
		filepath += "vertics.csv";
	else
	{
		if (pcs)
			filepath += "pcs.csv";
				...
				else if (open_bracket == 1)
				{
					if (ogc_wkt[curr] == '\"')
					{
						...
						if (strncmp(&ogc_wkt[curr], "Lambert_Conformal_Conic", 23) == 0)
						{
							...
							if (!get_parameter_from_ogc_wkt(&ogc_wkt[curr],
															"false_easting",
															&false_easting) &&
								!get_parameter_from_ogc_wkt(&ogc_wkt[curr],
															"False_Easting",
															&false_easting))
								return false;
							if (!get_parameter_from_ogc_wkt(&ogc_wkt[curr],
							...
							set_lambert_conformal_conic_projection(unit * false_easting,
																   unit * false_northing,
																   latitude_of_origin,
																   central_meridian,
																   standard_parallel_1,
						...
						else if (strncmp(&ogc_wkt[curr], "Transverse_Mercator", 19) == 0)
						{
							...
							if (!get_parameter_from_ogc_wkt(&ogc_wkt[curr],
								...
								return false;
							get_unit_from_ogc_wkt(&ogc_wkt[curr], &unit);
							set_transverse_mercator_projection(unit * false_easting,
															   unit * false_northing,
															   latitude_of_origin,
															   central_meridian,
															   scale_factor);
						...
						else if (strncmp(&ogc_wkt[curr], "Albers_Conic_Equal_Area", 23) == 0)
						{
							...
							if (!get_parameter_from_ogc_wkt(&ogc_wkt[curr],
								...
								return false;
							get_unit_from_ogc_wkt(&ogc_wkt[curr], &unit);
							set_albers_equal_area_conic_projection(unit * false_easting,
																   unit * false_northing,
																   latitude_of_center,
																   longitude_of_center,
																   standard_parallel_1,
...
static int print_ogc_wkt_datum(char* string,
...
static int print_ogc_wkt_geogcs(char* string,
								const char* gcs_name,
								short gcs_code,
								const char* datum_name,
								short datum_code,
								short spheroid_code)
{
	...
	n += sprintf(&string[n],
				 ...
				 "01745329251994328,AUTHORITY[\"EPSG\",\"9122\"]],AUTHORITY[\"EPSG\",\"%d\"]],",
				 gcs_code);
	...
	if (projection)
	{
		...
		if (projection->type == GEO_PROJECTION_ECEF)
		{
			n += sprintf(&string[n],
						 ...
						 "84\",6378137.0,298.257223563,AUTHORITY[\"EPSG\",\"7030\"]],AUTHORITY["
						 "\"EPSG\",\"6326\"]],PRIMEM[\"Greenwich\",0.0,AUTHORITY[\"EPSG\",\"8901\"]"
						 "],UNIT[\"m\",1.0],AXIS[\"Geocentric X\",OTHER],AXIS[\"Geocentric "
						 "Y\",EAST],AXIS[\"Geocentric Z\",NORTH],AUTHORITY[\"EPSG\",\"4978\"]]");
		}
		else
		{
			// if not geographic we have a projection
			if ((projection->type != GEO_PROJECTION_LAT_LONG) &&
				(projection->type != GEO_PROJECTION_LONG_LAT))
			{
			...
			if (gcs_code == GEO_GCS_NAD83_2011)
			{
				n += sprintf(&string[n],
							 ...
							 "\"EPSG\",\"1116\"]],PRIMEM[\"Greenwich\",0,AUTHORITY[\"EPSG\","
							 "\"8901\"]],UNIT[\"degree\",0.01745329251994328,AUTHORITY[\"EPSG\","
							 "\"9122\"]],AUTHORITY[\"EPSG\",\"6318\"]],");
			}
			else
			{
				n += print_ogc_wkt_geogcs(&string[n],
										  gcs_name,
										  gcs_code,
										  datum_name,
										  datum_code,
			...
			if (projection->type == GEO_PROJECTION_LONG_LAT)
			{
				...
				n += sprintf(&string[n], ",AXIS[\"Longitude\",EAST],AXIS[\"Latitude\",NORTH]]");
					 ...
					 GEO_PROJECTION_LAT_LONG) // or maybe geographic with reversed coordinates
			{
				n--; // remove comma
				n--; // remove bracket
			...
			else // some real projection
			{
				if (projection->type == GEO_PROJECTION_UTM)
				{
					...
					n += sprintf(
						...
						-183 + 6 * utm->utm_zone_number,
						(utm->utm_northern_hemisphere ? 0 : 10000000));
				}
				else if (projection->type == GEO_PROJECTION_LCC)
				{
					GeoProjectionParametersLCC* lcc = (GeoProjectionParametersLCC*)projection;
					n += sprintf(
						&string[n],
						"PROJECTION[\"Lambert_Conformal_Conic_2SP\"],PARAMETER[\"standard_parallel_"
						"1\",%.15g],PARAMETER[\"standard_parallel_2\",%.15g],PARAMETER[\"latitude_"
						"of_origin\",%.15g],PARAMETER[\"central_meridian\",%.15g],",
					...
					{
						n += sprintf(&string[n],
									 "PARAMETER[\"false_easting\",%.15g],PARAMETER[\"false_"
									 "northing\",%.15g],",
									 lcc->lcc_false_easting_meter / coordinates2meter,
									 lcc->lcc_false_northing_meter / coordinates2meter);
					}
					else
					{
						n += sprintf(&string[n],
									 "PARAMETER[\"false_easting\",%.15g],PARAMETER[\"false_"
									 "northing\",%.15g],",
									 lcc->lcc_false_easting_meter * meter2coordinates,
									 lcc->lcc_false_northing_meter * meter2coordinates);
					}
				}
				else if (projection->type == GEO_PROJECTION_TM)
				{
					GeoProjectionParametersTM* tm = (GeoProjectionParametersTM*)projection;
					n += sprintf(&string[n],
								 "PROJECTION[\"Transverse_Mercator\"],PARAMETER[\"latitude_of_"
								 "origin\",%.15g],PARAMETER[\"central_meridian\",%.15g],PARAMETER["
								 "\"scale_factor\",%.15g],",
								 tm->tm_lat_origin_degree,
								 tm->tm_long_meridian_degree,
								 tm->tm_scale_factor);
					if (source)
					{
						n += sprintf(&string[n],
									 "PARAMETER[\"false_easting\",%.15g],PARAMETER[\"false_"
									 "northing\",%.15g],",
									 tm->tm_false_easting_meter / coordinates2meter,
									 tm->tm_false_northing_meter / coordinates2meter);
					}
					else
					{
						n += sprintf(&string[n],
									 "PARAMETER[\"false_easting\",%.15g],PARAMETER[\"false_"
									 "northing\",%.15g],",
									 tm->tm_false_easting_meter * meter2coordinates,
									 tm->tm_false_northing_meter * meter2coordinates);
					}
				}
				else if (projection->type == GEO_PROJECTION_AEAC)
				{
					...
					n += sprintf(
						&string[n],
						"PROJECTION[\"Albers_Conic_Equal_Area\"],PARAMETER[\"standard_parallel_1\","
						"%.15g],PARAMETER[\"standard_parallel_2\",%.15g],PARAMETER[\"latitude_of_"
						"center\",%.15g],PARAMETER[\"longitude_of_center\",%.15g],",
						aeac->aeac_first_std_parallel_degree,
						aeac->aeac_second_std_parallel_degree,
						aeac->aeac_latitude_of_center_degree,
					...
					if (source)
					{
						n += sprintf(&string[n],
									 "PARAMETER[\"false_easting\",%.15g],PARAMETER[\"false_"
									 "northing\",%.15g],",
									 aeac->aeac_false_easting_meter / coordinates2meter,
									 aeac->aeac_false_northing_meter / coordinates2meter);
					}
					else
					{
						n += sprintf(&string[n],
									 "PARAMETER[\"false_easting\",%.15g],PARAMETER[\"false_"
									 "northing\",%.15g],",
									 aeac->aeac_false_easting_meter * meter2coordinates,
									 aeac->aeac_false_northing_meter * meter2coordinates);
					}
				}
				else if (projection->type == GEO_PROJECTION_HOM)
				{
					GeoProjectionParametersHOM* hom = (GeoProjectionParametersHOM*)projection;
					n += sprintf(&string[n],
								 "PROJECTION[\"Hotine_Oblique_Mercator\"],PARAMETER[\"latitude_of_"
								 "center\",%.15g],PARAMETER[\"longitude_of_center\",%.15g],"
								 "PARAMETER[\"azimuth\",%.15g],PARAMETER[\"rectified_grid_angle\",%"
								 ".15g],PARAMETER[\"scale_factor\",%.15g],",
								 hom->hom_latitude_of_center_degree,
								 hom->hom_longitude_of_center_degree,
								 hom->hom_azimuth_degree,
								 hom->hom_rectified_grid_angle_degree,
					...
					if (source)
					{
						n += sprintf(&string[n],
									 "PARAMETER[\"false_easting\",%.15g],PARAMETER[\"false_"
									 "northing\",%.15g],",
									 hom->hom_false_easting_meter / coordinates2meter,
									 hom->hom_false_northing_meter / coordinates2meter);
					}
					else
					{
						n += sprintf(&string[n],
									 "PARAMETER[\"false_easting\",%.15g],PARAMETER[\"false_"
									 "northing\",%.15g],",
									 hom->hom_false_easting_meter * meter2coordinates,
									 hom->hom_false_northing_meter * meter2coordinates);
					}
				}
				else if (projection->type == GEO_PROJECTION_OS)
				{
					...
					n += sprintf(&string[n],
								 "PROJECTION[\"Oblique_Stereographic\"],PARAMETER[\"latitude_of_"
								 "origin\",%.15g],PARAMETER[\"central_meridian\",%.15g],PARAMETER["
								 "\"scale_factor\",%.15g],",
								 os->os_lat_origin_degree,
								 os->os_long_meridian_degree,
								 os->os_scale_factor);
					if (source)
					{
						n += sprintf(&string[n],
									 "PARAMETER[\"false_easting\",%.15g],PARAMETER[\"false_"
									 "northing\",%.15g],",
									 os->os_false_easting_meter / coordinates2meter,
									 os->os_false_northing_meter / coordinates2meter);
					}
					else
					{
						n += sprintf(&string[n],
									 "PARAMETER[\"false_easting\",%.15g],PARAMETER[\"false_"
									 "northing\",%.15g],",
									 os->os_false_easting_meter * meter2coordinates,
									 os->os_false_northing_meter * meter2coordinates);
					}
				}
				else
				{
				...
				(vertical_geokey == GEO_VERTICAL_NZVD2016))
			{
				...
				{
					n += sprintf(&string[n],
								 "VERT_CS[\"NGVD29\",VERT_DATUM[\"National Geodetic Vertical Datum "
								 "1929\",2005,AUTHORITY[\"EPSG\",\"5102\"]],");
				}
				else if (vertical_geokey == GEO_VERTICAL_CGVD2013)
				{
					n += sprintf(&string[n],
								 "VERT_CS[\"CGVD2013\",VERT_DATUM[\"Canadian Geodetic Vertical "
								 "Datum of 2013\",2005,AUTHORITY[\"EPSG\",\"1127\"]],");
				}
				else if (vertical_geokey == GEO_VERTICAL_EVRF2007)
				{
					n += sprintf(&string[n],
								 "VERT_CS[\"EVRF2007\",VERT_DATUM[\"European Vertical Reference "
								 "Frame 2007\",2005,AUTHORITY[\"EPSG\",\"5215\"]],");
				}
				else if (vertical_geokey == GEO_VERTICAL_CGVD28)
				{
					n += sprintf(&string[n],
								 "VERT_CS[\"CGVD28\",VERT_DATUM[\"Canadian Geodetic Vertical Datum "
								 "of 1928\",2005,AUTHORITY[\"EPSG\",\"5114\"]],");
				}
				else if (vertical_geokey == GEO_VERTICAL_DVR90)
				{
					n += sprintf(&string[n],
								 "VERT_CS[\"DVR90\",VERT_DATUM[\"Dansk Vertikal Reference "
								 "1990\",2005,AUTHORITY[\"EPSG\",\"5206\"]],");
				}
				else if (vertical_geokey == GEO_VERTICAL_NN2000)
				{
					n += sprintf(&string[n],
								 "VERT_CS[\"NN2000\",VERT_DATUM[\"Norway Normal Null "
								 "2000\",2005,AUTHORITY[\"EPSG\",\"1096\"]],");
				}
				else if (vertical_geokey == GEO_VERTICAL_NN54)
				{
					n += sprintf(&string[n],
								 "VERT_CS[\"NN54\",VERT_DATUM[\"Norway Normal Null "
								 "1954\",2005,AUTHORITY[\"EPSG\",\"5174\"]],");
				}
				else if (vertical_geokey == GEO_VERTICAL_DHHN92)
				{
					n += sprintf(&string[n],
								 "VERT_CS[\"DHHN92\",VERT_DATUM[\"Deutsches Haupthoehennetz "
								 "1992\",2005,AUTHORITY[\"EPSG\",\"5783\"]],");
				}
				else if (vertical_geokey == GEO_VERTICAL_DHHN2016)
				{
					n += sprintf(&string[n],
								 "VERT_CS[\"DHHN2016\",VERT_DATUM[\"Deutsches Haupthoehennetz "
								 "2016\",2005,AUTHORITY[\"EPSG\",\"7837\"]],");
				}
				else if (vertical_geokey == GEO_VERTICAL_NZVD2016)
				{
					n += sprintf(&string[n],
								 "VERT_CS[\"NZVD2016\",VERT_DATUM[\"New Zealand Vertical Datum "
								 "2016\",2005,AUTHORITY[\"EPSG\",\"7839\"]],");
				}
				if (source)
				{
					if (elevation2meter == 1.0)
				...
				{
					n += sprintf(&string[n],
								 "AXIS[\"Gravity-related height\",UP],AUTHORITY[\"EPSG\",\"%d\"]]",
								 ((source && (elevation2meter == 1.0)) ||
										  (!source && (meter2elevation == 1.0))
									  ? 5703
									  : 6360));
				}
				else if (vertical_geokey == GEO_VERTICAL_NGVD29)
				{
					n += sprintf(
						&string[n],
						"AXIS[\"Gravity-related height\",UP],AUTHORITY[\"EPSG\",\"5702\"]]");
				}
				else if (vertical_geokey == GEO_VERTICAL_CGVD2013)
				{
					n += sprintf(
				...
				else if (vertical_geokey == GEO_VERTICAL_EVRF2007)
				{
					n += sprintf(
						&string[n],
						"AXIS[\"Gravity-related height\",UP],AUTHORITY[\"EPSG\",\"5621\"]]");
				}
				else if (vertical_geokey == GEO_VERTICAL_CGVD28)
				{
					n += sprintf(
						&string[n],
						"AXIS[\"Gravity-related height\",UP],AUTHORITY[\"EPSG\",\"5713\"]]");
				}
				else if (vertical_geokey == GEO_VERTICAL_DVR90)
				{
					n += sprintf(
						&string[n],
						"AXIS[\"Gravity-related height\",UP],AUTHORITY[\"EPSG\",\"5799\"]]");
				}
				else if (vertical_geokey == GEO_VERTICAL_NN2000)
				{
					n += sprintf(
				...
				else if (vertical_geokey == GEO_VERTICAL_NN54)
				{
					n += sprintf(
						&string[n],
						"AXIS[\"Gravity-related height\",UP],AUTHORITY[\"EPSG\",\"5776\"]]");
				}
				else if (vertical_geokey == GEO_VERTICAL_DHHN92)
				{
					n += sprintf(
						&string[n],
						"AXIS[\"Gravity-related height\",UP],AUTHORITY[\"EPSG\",\"5783\"]]");
				}
				else if (vertical_geokey == GEO_VERTICAL_DHHN2016)
				{
					n += sprintf(
						&string[n],
						"AXIS[\"Gravity-related height\",UP],AUTHORITY[\"EPSG\",\"7837\"]]");
				}
				else if (vertical_geokey == GEO_VERTICAL_NZVD2016)
				{
					n += sprintf(
						&string[n],
						"AXIS[\"Gravity-related height\",UP],AUTHORITY[\"EPSG\",\"7839\"]]");
				}
...
static int print_prj_datum(char* string,
						   const char* datum_name,
						   short datum_code,
						   short spheroid_code)
{
...
static int print_prj_geogcs(char* string,
							const char* gcs_name,
							short gcs_code,
							const char* datum_name,
							short datum_code,
...
bool GeoProjectionConverter::get_prj_from_projection(int& len, char** prj, bool source)
{
	...
	if (projection)
	{
		...
		else
		{
			...
			else if ((gcs_code == GEO_GCS_NAD83) || (gcs_code == GEO_GCS_NAD83_HARN) ||
					 (gcs_code == GEO_GCS_NAD83_CSRS) || (gcs_code == GEO_GCS_NAD83_PA11) ||
					 (gcs_code == GEO_GCS_NAD83_2011))
			{
				...
				{
					n += sprintf(&string[n],
								 "GEOGCS[\"NAD83(HARN)\",DATUM[\"D_North_American_1983_HARN\",");
				}
				else if (gcs_code == GEO_GCS_NAD83_CSRS)
				{
					n += sprintf(&string[n],
								 "GEOGCS[\"NAD83(CSRS)\",DATUM[\"D_NAD83_Canadian_Spatial_"
								 "Reference_System\",");
				}
				else if (gcs_code == GEO_GCS_NAD83_PA11)
				{
					n += sprintf(&string[n],
								 "GEOGCS[\"NAD83(PA11)\",DATUM[\"D_North_American_1983_PA11\",");
				}
				else
				{
					n += sprintf(&string[n],
								 "GEOGCS[\"NAD83(2011)\",DATUM[\"D_North_American_1983_2011\",");
				}
				n += sprintf(&string[n],
							 "SPHEROID[\"GRS "
			...
			(vertical_geokey == GEO_VERTICAL_NZVD2016))
		{
			...
			{
				n += sprintf(&string[n],
							 "VERT_CS[\"NAVD88\",VERT_DATUM[\"North American Vertical Datum "
							 "1988\",2005,AUTHORITY[\"EPSG\",\"5103\"]],");
			}
			else if (vertical_geokey == GEO_VERTICAL_NGVD29)
			{
			...
			{
				n += sprintf(&string[n],
							 "VERT_CS[\"CGVD2013\",VERT_DATUM[\"Canadian Geodetic Vertical Datum "
							 "of 2013\",2005,AUTHORITY[\"EPSG\",\"1127\"]],");
			}
			else if (vertical_geokey == GEO_VERTICAL_EVRF2007)
			{
				n += sprintf(&string[n],
							 "VERT_CS[\"EVRF2007\",VERT_DATUM[\"European Vertical Reference Frame "
							 "2007\",2005,AUTHORITY[\"EPSG\",\"5215\"]],");
			}
			else if (vertical_geokey == GEO_VERTICAL_CGVD28)
			{
				n += sprintf(&string[n],
							 "VERT_CS[\"CGVD28\",VERT_DATUM[\"Canadian Geodetic Vertical Datum of "
							 "1928\",2005,AUTHORITY[\"EPSG\",\"5114\"]],");
			}
			else if (vertical_geokey == GEO_VERTICAL_DVR90)
			{
				n += sprintf(&string[n],
			...
			if (vertical_geokey == GEO_VERTICAL_NAVD88)
			{
				n += sprintf(
					&string[n],
					"AXIS[\"Gravity-related height\",UP],AUTHORITY[\"EPSG\",\"%d\"]]",
					((source && (elevation2meter == 1.0)) || (!source && (meter2elevation == 1.0))
						 ? 5703
						 : 6360));
			}
			else if (vertical_geokey == GEO_VERTICAL_NGVD29)
...
bool GeoProjectionConverter::get_proj4_string_from_projection(int& len, char** proj4, bool source)
{
	...
	if (projection)
	{
		...
		else if (projection->type == GEO_PROJECTION_LCC)
		{
			GeoProjectionParametersLCC* lcc = (GeoProjectionParametersLCC*)projection;
			n += sprintf(&string[n],
						 "+proj=lcc +lat_1=%.15g +lat_2=%.15g +lat_0=%.15g +lon_0=%.15g +x_0=%.15g "
						 "+y_0=%.15g ",
						 lcc->lcc_first_std_parallel_degree,
						 lcc->lcc_second_std_parallel_degree,
						 lcc->lcc_lat_origin_degree,
		...
		else if (projection->type == GEO_PROJECTION_TM)
		{
			GeoProjectionParametersTM* tm = (GeoProjectionParametersTM*)projection;
			n += sprintf(&string[n],
						 "+proj=tmerc +lat_0=%.15g +lon_0=%.15g +k=%.15g +x_0=%.15g +y_0=%.15g ",
						 tm->tm_lat_origin_degree,
						 tm->tm_long_meridian_degree,
						 tm->tm_scale_factor,
						 tm->tm_false_easting_meter,
						 tm->tm_false_northing_meter);
		}
		else if (projection->type == GEO_PROJECTION_AEAC)
		{
			GeoProjectionParametersAEAC* aeac = (GeoProjectionParametersAEAC*)projection;
			n += sprintf(&string[n],
						 "+proj=albers +lat_1=%.15g +lat_2=%.15g +lat_0=%.15g +lon_0=%.15g "
						 "+x_0=%.15g +y_0=%.15g ",
						 aeac->aeac_first_std_parallel_degree,
						 aeac->aeac_second_std_parallel_degree,
						 aeac->aeac_latitude_of_center_degree,
						 aeac->aeac_longitude_of_center_degree,
						 aeac->aeac_false_easting_meter,
						 aeac->aeac_false_northing_meter);
		}
		else if (projection->type == GEO_PROJECTION_HOM)
		{
			GeoProjectionParametersHOM* hom = (GeoProjectionParametersHOM*)projection;
			n += sprintf(&string[n],
						 "+proj=omerc +lat_0=%.15g +lonc=%.15g +alpha=%.15g +gamma=%.15g +k=%.15g "
						 "+x_0=%.15g +y_0=%.15g ",
						 hom->hom_latitude_of_center_degree,
						 hom->hom_longitude_of_center_degree,
						 hom->hom_azimuth_degree,
						 hom->hom_rectified_grid_angle_degree,
						 hom->hom_scale_factor,
						 hom->hom_false_easting_meter,
						 hom->hom_false_northing_meter);
		}
		else if (projection->type == GEO_PROJECTION_OS)
		{
			GeoProjectionParametersOS* os = (GeoProjectionParametersOS*)projection;
			n += sprintf(&string[n],
						 "+proj=sterea +lat_0=%.15g +lon_0=%.15g +k=%.15g +x_0=%.15g +y_0=%.15g ",
						 os->os_lat_origin_degree,
						 os->os_long_meridian_degree,
						 os->os_scale_factor,
						 os->os_false_easting_meter,
						 os->os_false_northing_meter);
		}
...
short GeoProjectionConverter::get_GTModelTypeGeoKey() const
{
	...
	{
		if ((source_projection->type == GEO_PROJECTION_LONG_LAT) ||
			(source_projection->type == GEO_PROJECTION_LAT_LONG))
		{
			return 2; // ModelTypeGeographic
		}
		if ((source_projection->type == GEO_PROJECTION_LCC) ||
			(source_projection->type == GEO_PROJECTION_TM) ||
			(source_projection->type == GEO_PROJECTION_AEAC) ||
			(source_projection->type == GEO_PROJECTION_HOM) ||
...
short GeoProjectionConverter::get_GeographicTypeGeoKey() const
{
	...
	default:
		fprintf(stderr,
				"GeographicTypeGeoKey: look-up for ellipsoid with id %d not implemented\n",
				ellipsoid->id);
	}
	return 0;
}
			...
			else
			{
				...
				else if (gcs_code == GEO_GCS_NAD83_CSRS)
				{
					if (utm->utm_northern_hemisphere)
					{
						...
						{
							unsigned short epsg_codes_NAD83_CSRS[] = { 3154, 3155, 3156, 3157,
																	   2955, 2956, 2957, 3158,
																	   3159, 3160, 2958, 2959,
																	   2960, 2961, 2962, 3761 };
				...
				else if (ellipsoid->id == GEO_ELLIPSOID_GRS1980)
				{
					if (utm->utm_northern_hemisphere)
					{
						...
						{
							fprintf(stderr,
									"get_ProjectedCSTypeGeoKey: northern UTM zone %d for NAD83 "
									"out-of-range\n",
									utm->utm_zone_number);
						}
					}
					else
					{
						if (gcs_code == GEO_GCS_GDA94)
						{
							...
							{
								fprintf(stderr,
										"get_ProjectedCSTypeGeoKey: southern MGA zone %d for GDA94 "
										"does not exist\n",
										utm->utm_zone_number);
							}
						}
						else if (gcs_code == GEO_GCS_GDA2020)
						{
							...
							{
								fprintf(stderr,
										"get_ProjectedCSTypeGeoKey: southern MGA zone %d for "
										"GDA2020 does not exist\n",
										utm->utm_zone_number);
							}
						}
						else
						{
							fprintf(stderr,
									"get_ProjectedCSTypeGeoKey: southern UTM zone %d for NAD83 "
									"does not exist\n",
									utm->utm_zone_number);
						}
					}
				...
				else if (ellipsoid->id == GEO_ELLIPSOID_CLARKE1866)
				{
					if (utm->utm_northern_hemisphere)
					{
						...
						{
							fprintf(stderr,
									"get_ProjectedCSTypeGeoKey: northern UTM zone %d for NAD27 "
									"out-of-range\n",
									utm->utm_zone_number);
						}
					}
					...
					{
						fprintf(stderr,
								"get_ProjectedCSTypeGeoKey: southern UTM zone %d for NAD27 does "
								"not exist\n",
								utm->utm_zone_number);
					}
				}
				else if (ellipsoid->id == GEO_ELLIPSOID_GRS1967)
				{
					if (utm->utm_northern_hemisphere)
					{
						...
						{
							fprintf(stderr,
									"get_ProjectedCSTypeGeoKey: northern UTM zone %d for SAD69 "
									"out-of-range\n",
									utm->utm_zone_number);
						}
					}
					else
					{
						...
						{
							fprintf(stderr,
									"get_ProjectedCSTypeGeoKey: southern UTM zone %d for SAD69 "
									"out-of-range\n",
									utm->utm_zone_number);
						}
					}
				...
				else if (ellipsoid->id == GEO_ELLIPSOID_INTERNATIONAL)
				{
					if (utm->utm_northern_hemisphere)
					{
						...
						{
							fprintf(stderr,
									"get_ProjectedCSTypeGeoKey: northern UTM zone %d for ED50 "
									"out-of-range\n",
									utm->utm_zone_number);
						}
					}
					...
					{
						fprintf(stderr,
								"get_ProjectedCSTypeGeoKey: southern UTM zone %d for ED50 does not "
								"exist\n",
								utm->utm_zone_number);
					}
				}
				else if (ellipsoid->id == GEO_ELLIPSOID_ID74)
				{
					if (utm->utm_northern_hemisphere)
					{
						...
						{
							fprintf(stderr,
									"get_ProjectedCSTypeGeoKey: northern UTM zone %d for ID74 "
									"out-of-range\n",
									utm->utm_zone_number);
						}
					}
					else
					{
						...
						{
							fprintf(stderr,
									"get_ProjectedCSTypeGeoKey: southern UTM zone %d for ID74 "
									"out-of-range\n",
									utm->utm_zone_number);
						}
					}
				...
				{
					fprintf(stderr,
							"get_ProjectedCSTypeGeoKey: look-up for UTM zone %d and ellipsoid with "
...
short GeoProjectionConverter::get_GeogEllipsoidGeoKey() const
{
	...
	default:
		fprintf(stderr,
				"GeogEllipsoidGeoKey: look-up for ellipsoid with id %d not implemented\n",
				ellipsoid->id);
	}
	return 0;
}
...
short GeoProjectionConverter::get_ProjLinearUnitsGeoKey(bool source) const
{
	if (source)
	{
		if (source_projection && (source_projection->type == GEO_PROJECTION_LONG_LAT ||
								  source_projection->type == GEO_PROJECTION_LAT_LONG))
		{
			return 9000;
		}
	...
	{
		if (target_projection && (target_projection->type == GEO_PROJECTION_LONG_LAT ||
								  target_projection->type == GEO_PROJECTION_LAT_LONG))
		{
			return 9000;
		}
...
bool GeoProjectionConverter::set_VerticalCSTypeGeoKey(short value, char* description)
{
	if (value == GEO_VERTICAL_WGS84)
	{
		...
		if (description)
			sprintf(description, "WGS 84 Ellipsoid");
		return true;
	}
	else if (value == GEO_VERTICAL_NAVD88)
	{
		...
		if (description)
			sprintf(description, "North American Vertical Datum 1988");
		return true;
	}
	else if (value == GEO_VERTICAL_DHHN2016)
	{
		vertical_geokey = GEO_VERTICAL_DHHN2016;
		if (description)
			sprintf(description, "Deutsches Haupthoehennetz 2016");
		return true;
	}
	else if (value == GEO_VERTICAL_NZVD2016)
	{
		vertical_geokey = GEO_VERTICAL_NZVD2016;
		if (description)
			sprintf(description, "New Zealand Vertical Datum 2016");
		return true;
	}
	else if (value == GEO_VERTICAL_DHHN92)
	{
		vertical_geokey = GEO_VERTICAL_DHHN92;
		if (description)
			sprintf(description, "Deutsches Haupthoehennetz 1992");
		return true;
	}
	else if (value == GEO_VERTICAL_CGVD2013)
	{
		vertical_geokey = GEO_VERTICAL_CGVD2013;
		if (description)
			sprintf(description, "Canadian Geodetic Vertical Datum of 2013");
		return true;
	}
	else if (value == GEO_VERTICAL_NN2000)
	{
		vertical_geokey = GEO_VERTICAL_NN2000;
		if (description)
			sprintf(description, "Norway Normal Null 2000");
		return true;
	}
	else if (value == GEO_VERTICAL_NN54)
	{
		vertical_geokey = GEO_VERTICAL_NN54;
		if (description)
			sprintf(description, "Norway Normal Null 1954");
		return true;
	}
	else if (value == GEO_VERTICAL_EVRF2007)
	{
		vertical_geokey = GEO_VERTICAL_EVRF2007;
		if (description)
			sprintf(description, "European Vertical Reference Frame 2007");
		return true;
	}
	else if (value == GEO_VERTICAL_DVR90)
	{
		vertical_geokey = GEO_VERTICAL_DVR90;
		if (description)
			sprintf(description, "Dansk Vertikal Reference 1990");
		return true;
	}
	else if (value == GEO_VERTICAL_NGVD29)
	{
		vertical_geokey = GEO_VERTICAL_NGVD29;
		if (description)
			sprintf(description, "National Geodetic Vertical Datum 1929");
		return true;
	}
	else if (value == GEO_VERTICAL_CGVD28)
	{
		vertical_geokey = GEO_VERTICAL_CGVD28;
		if (description)
			sprintf(description, "Canadian Geodetic Vertical Datum of 1928");
		return true;
	}
	else if ((5000 <= value) && (value <= 5099)) // [5000, 5099] = EPSG Ellipsoid Vertical CS Codes
	{
		...
		if (description)
			sprintf(description, "Some Ellipsoid Vertical Datum");
		return true;
	}
	else
	{
		...
		while (fgets(line, 2048, file))
		{
			if (sscanf(line, "%d,", &epsg_code) == 1)
			{
				if (epsg_code == value)
				{
					...
					{
						fprintf(stderr,
								"units %d of EPSG code %d not implemented.\n",
								units,
								value);
						return false;
					}
...
bool GeoProjectionConverter::set_reference_ellipsoid(int id, char* description)
{
	...
	ellipsoid->eccentricity_prime_squared =
		(ellipsoid->eccentricity_squared) / (1 - ellipsoid->eccentricity_squared);
	ellipsoid->polar_radius =
		ellipsoid->equatorial_radius * sqrt(1 - ellipsoid->eccentricity_squared);
	ellipsoid->eccentricity = sqrt(ellipsoid->eccentricity_squared);
	ellipsoid->eccentricity_e1 = (1 - sqrt(1 - ellipsoid->eccentricity_squared)) /
								 (1 + sqrt(1 - ellipsoid->eccentricity_squared));
...
int GeoProjectionConverter::get_ellipsoid_id() const { return ellipsoid->id; }

const char* GeoProjectionConverter::get_ellipsoid_name() const { return ellipsoid->name; }
...
bool GeoProjectionConverter::set_gcs(short code, char* description)
{
	...
	else
	{
		...
		{
			fprintf(stderr,
					"ERROR: cannot open 'gcs.csv' file. maybe your LAStools distribution\n");
			fprintf(stderr,
					"       has no .\\LAStools\\bin\\serf\\geo\\gcs.csv file. download the\n");
			fprintf(stderr, "       latest version at http://lastools.org/download/LAStools.zip\n");
			return false;
		}
		int value = 0;
			...
			if (sscanf(line, "%d,", &value) == 1)
			{
				if (code == value)
				{
					...
					if (sscanf(&line[run], "%d,", &value) == 1)
					{
						...
						if (ellipsoid_id != -1)
						{
							//              fprintf(stderr, "set ellipsoid %d for EPSG code %d for
						...
						{
							fprintf(stderr,
									"ERROR: ellipsoid with EPSG code %d for '%s' not supported\n",
									value,
									gname);
							break;
						}
	...
	if (description)
		sprintf(description, "%s", gcs_name);
	return true;
}

const char* GeoProjectionConverter::get_gcs_name() const { return gcs_name; }
...
void GeoProjectionConverter::check_geokey(short geokey, bool source)
{
	if (source)
	{
		if (source_projection)
		{
			...
			{
				fprintf(stderr,
						"WARNING: source_projection->geokey %d != geokey %d\n",
						source_projection->geokey,
						geokey);
			}
		}
		else
	...
	else
	{
		if (target_projection)
		{
			...
			{
				fprintf(stderr,
						"WARNING: target_projection->geokey %d != geokey %d\n",
						target_projection->geokey,
						geokey);
			}
		}
		else
...
bool GeoProjectionConverter::set_utm_projection(char* zone,
												char* description,
												bool source,
												const char* name,
												bool is_mga)
{
	...
	else
	{
		sprintf(utm->name,
				...
				(is_mga ? "MGA" : "UTM"),
				zone_number,
				(utm->utm_northern_hemisphere ? "N" : "S"));
	}
...
bool GeoProjectionConverter::set_utm_projection(int zone,
												bool northern,
												char* description,
												bool source,
												const char* name,
...
void GeoProjectionConverter::set_lambert_conformal_conic_projection(double falseEastingMeter,
																	double falseNorthingMeter,
																	double latOriginDegree,
																	double longMeridianDegree,
																	double firstStdParallelDegree,
																	...
																	const char* name)
{
	...
	{
		sprintf(description,
				"false east/north: %g/%g [m], origin lat/ meridian long: %g/%g, parallel 1st/2nd: "
				"%g/%g",
				lcc->lcc_false_easting_meter,
				lcc->lcc_false_northing_meter,
				lcc->lcc_lat_origin_degree,
 ...
 */
void GeoProjectionConverter::set_transverse_mercator_projection(double falseEastingMeter,
																double falseNorthingMeter,
																double latOriginDegree,
																double longMeridianDegree,
																double scaleFactor,
																...
																const char* name)
{
	...
	{
		sprintf(description,
				"false east/north: %g/%g [m], origin lat/meridian long: %g/%g, scale: %g",
				tm->tm_false_easting_meter,
				tm->tm_false_northing_meter,
				tm->tm_lat_origin_degree,
				tm->tm_long_meridian_degree,
...
// longitude in decimal degrees (that is they run east-west) that define
// where the "cone" intersects the earth. They bracket the area being projected.
void GeoProjectionConverter::set_albers_equal_area_conic_projection(double falseEastingMeter,
																	double falseNorthingMeter,
																	...
																	const char* name)
{
	...
	{
		sprintf(description,
				"false east/north: %g/%g [m], center lat/long: %g/%g, parallel 1st/2nd: %g/%g",
				aeac->aeac_false_easting_meter,
				aeac->aeac_false_northing_meter,
				aeac->aeac_latitude_of_center_degree,
				aeac->aeac_longitude_of_center_degree,
...
// will be calculated in meters relative to this point on the earth.
//
void GeoProjectionConverter::set_hotine_oblique_mercator_projection(double falseEastingMeter,
																	double falseNorthingMeter,
																	double latCenterDegree,
																	double longCenterDegree,
																	...
																	const char* name)
{
	...
	if (description)
	{
		sprintf(
			description,
			"false east/north: %g/%g [m], center lat/long: %g/%g, azimuth: %g angle: %g scale: %g",
			hom->hom_false_easting_meter,
			hom->hom_false_northing_meter,
			hom->hom_latitude_of_center_degree,
			hom->hom_longitude_of_center_degree,
 ...
 * scaleFactor         : Projection scale factor
 */
void GeoProjectionConverter::set_oblique_stereographic_projection(double falseEastingMeter,
																  double falseNorthingMeter,
																  double latOriginDegree,
																  double longMeridianDegree,
																  double scaleFactor,
...
static double unit2decdeg(double length, int unit)
{
	...
	else if (unit == 9110)
	{
		...
		//    fprintf(stderr, "length: %.15g fraction %.15g decimal: %.15g mins: %.15g secs:
...
bool GeoProjectionConverter::set_epsg_code(short value, char* description, bool source)
{
	...
	else if ((value >= 32701) && (value <= 32760)) // PCS_WGS84_UTM_zone_1S - PCS_WGS84_UTM_zone_60S
	{
		...
		gcs = GEO_GCS_WGS84;
			 ...
			 (value <= 25838)) // PCS_ETRS89_UTM_zone_28N - PCS_ETRS89_UTM_zone_38N
	{
		utm_northern = true;
	...
	else if ((value >= 26903) && (value <= 26923)) // PCS_NAD83_UTM_zone_3N - PCS_NAD83_UTM_zone_23N
	{
		...
		gcs = GEO_GCS_NAD83;
			 ...
			 (value <= 3160)) // NAD83(CSRS) / UTM zone 7N - NAD83(CSRS) / UTM zone 16N
	{
		utm_northern = true;
		...
		gcs = GEO_GCS_NAD83_CSRS;
			 ...
			 (value <= 7859)) // PCS_GDA2020_MGA_zone_46S - PCS_GDA2020_MGA_zone_59S
	{
		utm_northern = false;
		utm_zone = value - 7800;
		is_mga = true;
	...
	else if ((value >= 28348) && (value <= 28358)) // PCS_GDA94_MGA_zone_48 - PCS_GDA94_MGA_zone_58
	{
		...
		gcs = GEO_GCS_GDA94;
			 ...
			 (value <= 29122)) // PCS_SAD69_UTM_zone_18N - PCS_SAD69_UTM_zone_22N
	{
		utm_northern = true;
		...
		gcs = GEO_GCS_SAD69;
			 ...
			 (value <= 29185)) // PCS_SAD69_UTM_zone_17S - PCS_SAD69_UTM_zone_25S
	{
		utm_northern = false;
	...
	else if ((value >= 32301) && (value <= 32360)) // PCS_WGS72_UTM_zone_1S - PCS_WGS72_UTM_zone_60S
	{
		...
		gcs = GEO_GCS_WGS72;
			 ...
			 (value <= 32460)) // PCS_WGS72BE_UTM_zone_1N - PCS_WGS72BE_UTM_zone_60N
	{
		utm_northern = true;
		...
		gcs = GEO_GCS_WGS72BE;
			 ...
			 (value <= 32560)) // PCS_WGS72BE_UTM_zone_1S - PCS_WGS72BE_UTM_zone_60S
	{
		utm_northern = false;
	...
	else if ((value >= 26703) && (value <= 26723)) // PCS_NAD27_UTM_zone_3N - PCS_NAD27_UTM_zone_23N
	{
		...
		case 4978: // WGS 84 ecef
			...
			gcs = GEO_GCS_WGS84;
			break;
		case EPSG_EOV_HD72: // should really be Hotine_Oblique_Mercator (but is special case with 90
							// degree angle that reduces to TM)
			set_gcs(GEO_GCS_HD72);
			set_transverse_mercator_projection(650000.0,
											   200000.0,
											   47.14439372222222,
											   19.04857177777778,
											   0.99993,
											   0,
											   source,
											   "EOV / HD72 / Hungarian National Grid");
			set_geokey(value, source);
			set_coordinates_in_meter(source);
			if (description)
				sprintf(description, "%s", gcs_name);
			return true;
		case EPSG_CH1903_LV03: // should really be Hotine_Oblique_Mercator (but is special case with
							   // 90 degree angle that reduces to TM)
			set_gcs(GEO_GCS_CH1903);
			set_transverse_mercator_projection(600000.0,
											   200000.0,
											   46.95240555555556,
											   7.439583333333333,
											   1.0,
			...
			while (fgets(line, 2048, file))
			{
				if (sscanf(line, "%d,", &epsg_code) == 1)
				{
					if (epsg_code == value)
					{
						...
						{
							fprintf(stderr,
									"failed to scan units, gcs, and transform from '%s'",
									line);
							return false;
						}
						...
						{
							fprintf(stderr,
									"GCS %d of EPSG code %d not implemented.\n",
									gcs,
									value);
							return false;
						}
						...
						if (transform == 9807) // CT_TransverseMercator
						{
							...
							if (sscanf(&line[run],
									   "%lf,%d,%d,%lf,%d,%d,%lf,%d,%d,%lf,%d,%d,%lf,%d",
									   &latitude_of_origin,
									   &unit_latitude_of_origin,
									   &dummy,
									   &central_meridian,
									   &unit_central_meridian,
									   &dummy,
									   &scale_factor,
									   &dummy,
									   &dummy,
							...
							double latitude_of_origin_decdeg =
								unit2decdeg(latitude_of_origin, unit_latitude_of_origin);
							double central_meridian_decdeg =
								unit2decdeg(central_meridian, unit_central_meridian);
							double false_easting_meter =
								unit2meter(false_easting, unit_false_easting);
							double false_northing_meter =
								unit2meter(false_northing, unit_false_northing);
							set_transverse_mercator_projection(false_easting_meter,
															   false_northing_meter,
															   latitude_of_origin_decdeg,
															   central_meridian_decdeg,
															   scale_factor,
															   0,
															   source,
															   name);
						...
						else if (transform == 9802) // CT_LambertConfConic_2SP
						{
							...
							int unit_false_northing;
							if (sscanf(&line[run],
									   "%lf,%d,%d,%lf,%d,%d,%lf,%d,%d,%lf,%d,%d,%lf,%d,%d,%lf,%d",
									   &latitude_of_origin,
									   &unit_latitude_of_origin,
									   &dummy,
									   &central_meridian,
									   ...
									   &dummy,
									   &standard_parallel_1,
									   &unit_standard_parallel_1,
									   &dummy,
									   &standard_parallel_2,
									   &unit_standard_parallel_2,
									   &dummy,
									   &false_easting,
									   &unit_false_easting,
									   &dummy,
							...
							{
								fprintf(stderr,
										"failed to scan LCC(2SP) parameters from '%s'\n",
										line);
								return false;
							}
							double latitude_of_origin_decdeg =
							...
							double central_meridian_decdeg =
								unit2decdeg(central_meridian, unit_central_meridian);
							double standard_parallel_1_decdeg =
								unit2decdeg(standard_parallel_1, unit_standard_parallel_1);
							double standard_parallel_2_decdeg =
								unit2decdeg(standard_parallel_2, unit_standard_parallel_2);
							double false_easting_meter =
								unit2meter(false_easting, unit_false_easting);
							double false_northing_meter =
								unit2meter(false_northing, unit_false_northing);
							set_lambert_conformal_conic_projection(false_easting_meter,
																   false_northing_meter,
																   latitude_of_origin_decdeg,
																   central_meridian_decdeg,
																   standard_parallel_1_decdeg,
																   standard_parallel_2_decdeg,
																   0,
																   source,
																   name);
							set_geokey(value, source);
						...
						else if (transform == 9801) // CT_LambertConfConic_1SP
						{
							...
							if (sscanf(&line[run],
									   ...
									   &unit_latitude_of_natural_origin,
									   &dummy,
									   &longitude_of_natural_origin,
									   &unit_longitude_of_natural_origin,
									   &dummy,
							...
							{
								fprintf(stderr,
										"failed to scan LCC(1SP) parameters from '%s'\n",
										line);
								return false;
							}
							double latitude_of_natural_origin_decdeg =
								unit2decdeg(latitude_of_natural_origin,
											unit_latitude_of_natural_origin);
							double longitude_of_natural_origin_decdeg =
								unit2decdeg(longitude_of_natural_origin,
											unit_longitude_of_natural_origin);
							double false_easting_meter =
								unit2meter(false_easting, unit_false_easting);
							double false_northing_meter =
							...
							/*
							   ...
							   latitude_of_natural_origin_decdeg); fprintf(stderr, "Longitude of
							   natural origin: %.10g\n", longitude_of_natural_origin_decdeg);
										fprintf(stderr, "Scale factor at natural origin: %.10g\n",
							   scale_factor_at_natural_origin); fprintf(stderr, "False easting:
							   %.10g\n", false_easting_meter); fprintf(stderr, "False northing:
							   %.10g\n", false_northing_meter);
							*/
							if (scale_factor_at_natural_origin != 1.0)
								fprintf(
									stderr,
									"\nWARNING: current implementation for Lambert Conic Conformal "
									"(1SP) ignores scale factor %.10g and uses 1.0 instead\n",
									scale_factor_at_natural_origin);
						...
						else if (transform == 9822) // CT_AlbersEqualArea
						{
							...
							if (sscanf(&line[run],
									   "%lf,%d,%d,%lf,%d,%d,%lf,%d,%d,%lf,%d,%d,%lf,%d,%d,%lf,%d",
									   &latitude_of_center,
									   &unit_latitude_of_center,
									   &dummy,
									   &longitude_of_center,
									   &unit_longitude_of_center,
									   &dummy,
									   &standard_parallel_1,
									   &unit_standard_parallel_1,
									   &dummy,
							...
							double latitude_of_center_decdeg =
								unit2decdeg(latitude_of_center, unit_latitude_of_center);
							double longitude_of_center_decdeg =
								unit2decdeg(longitude_of_center, unit_longitude_of_center);
							double standard_parallel_1_decdeg =
								unit2decdeg(standard_parallel_1, unit_standard_parallel_1);
							double standard_parallel_2_decdeg =
								unit2decdeg(standard_parallel_2, unit_standard_parallel_2);
							...
							double false_northing_meter =
								unit2meter(false_northing, unit_false_northing);
							set_albers_equal_area_conic_projection(false_easting_meter,
																   false_northing_meter,
																   latitude_of_center_decdeg,
																   longitude_of_center_decdeg,
																   standard_parallel_1_decdeg,
																   standard_parallel_2_decdeg,
																   0,
																   source,
						...
						else if (transform == 9812 ||
								 transform ==
									 9815) // CT_HotineObliqueMercator (or CT_ObliqueMercator)
						{
							double false_easting;
							int unit_false_easting;
							double false_northing;
							...
							double rectified_grid_angle_decdeg =
								unit2decdeg(rectified_grid_angle, unit_rectified_grid_angle);
							set_hotine_oblique_mercator_projection(false_easting_meter,
																   false_northing_meter,
																   latitude_of_center_decdeg,
																   longitude_of_center_decdeg,
																   azimuth_decdeg,
																   rectified_grid_angle_decdeg,
																   scale_factor,
																   0,
																   source,
																   name);
						...
						else if (transform == 9809) // CT_ObliqueStereographic
						{
							...
							double false_northing_meter =
								unit2meter(false_northing, unit_false_northing);
							set_oblique_stereographic_projection(false_easting_meter,
																 false_northing_meter,
																 latitude_of_origin_decdeg,
																 central_meridian_decdeg,
																 scale_factor,
						...
						{
							fprintf(stderr,
									"transform %d of EPSG code %d not implemented.\n",
									transform,
									value);
							return false;
						}
...
bool GeoProjectionConverter::set_state_plane_nad27_lcc(const char* zone,
													   char* description,
													   bool source,
													   const char* name)
{
...
void GeoProjectionConverter::print_all_state_plane_nad27_lcc() const
{
	...
	{
		fprintf(stderr,
				"%s - false east/north: %g/%g [m], origin lat/meridian long: %g/%g, parallel "
				"1st/2nd: %g/%g\n",
				state_plane_lcc_nad27_list[i].zone,
				state_plane_lcc_nad27_list[i].falseEastingMeter,
				state_plane_lcc_nad27_list[i].falseNorthingMeter,
				state_plane_lcc_nad27_list[i].latOriginDegree,
				state_plane_lcc_nad27_list[i].longMeridianDegree,
				state_plane_lcc_nad27_list[i].firstStdParallelDegree,
...
bool GeoProjectionConverter::set_state_plane_nad83_lcc(const char* zone,
													   char* description,
													   bool source,
													   const char* name)
{
...
void GeoProjectionConverter::print_all_state_plane_nad83_lcc() const
{
	...
	while (state_plane_lcc_nad83_list[i].zone)
	{
		fprintf(stderr,
				...
				state_plane_lcc_nad83_list[i].falseEastingMeter,
				state_plane_lcc_nad83_list[i].falseNorthingMeter,
				state_plane_lcc_nad83_list[i].latOriginDegree,
				state_plane_lcc_nad83_list[i].longMeridianDegree,
				state_plane_lcc_nad83_list[i].firstStdParallelDegree,
...
bool GeoProjectionConverter::set_state_plane_nad27_tm(const char* zone,
													  char* description,
													  bool source,
													  const char* name)
{
...
void GeoProjectionConverter::print_all_state_plane_nad27_tm() const
{
	...
	while (state_plane_tm_nad27_list[i].zone)
	{
		fprintf(
			stderr,
			"%s - false east/north: %g/%g [m], origin lat/meridian long: %g/%g, scale factor: %g\n",
			state_plane_tm_nad27_list[i].zone,
			state_plane_tm_nad27_list[i].falseEastingMeter,
			state_plane_tm_nad27_list[i].falseNorthingMeter,
			state_plane_tm_nad27_list[i].latOriginDegree,
			state_plane_tm_nad27_list[i].longMeridianDegree,
			state_plane_tm_nad27_list[i].scaleFactor);
		i++;
	}
}
...
bool GeoProjectionConverter::set_state_plane_nad83_tm(const char* zone,
													  char* description,
													  bool source,
													  const char* name)
{
...
void GeoProjectionConverter::print_all_state_plane_nad83_tm() const
{
	...
	while (state_plane_tm_nad83_list[i].zone)
	{
		fprintf(
			...
			state_plane_tm_nad83_list[i].falseEastingMeter,
			state_plane_tm_nad83_list[i].falseNorthingMeter,
			state_plane_tm_nad83_list[i].latOriginDegree,
			state_plane_tm_nad83_list[i].longMeridianDegree,
			state_plane_tm_nad83_list[i].scaleFactor);
		i++;
	}
}
...
{
	GeoProjectionParametersLCC* lcc =
		(GeoProjectionParametersLCC*)(source ? source_projection : target_projection);

	if (!lcc || lcc->type != GEO_PROJECTION_LCC)
		return;

	double es_sin = ellipsoid->eccentricity * sin(lcc->lcc_lat_origin_radian);
	double t0 = tan(PI_OVER_4 - lcc->lcc_lat_origin_radian / 2) /
				pow((1.0 - es_sin) / (1.0 + es_sin), (ellipsoid->eccentricity / 2.0));
	es_sin = ellipsoid->eccentricity * sin(lcc->lcc_first_std_parallel_radian);
	double t1 = tan(PI_OVER_4 - lcc->lcc_first_std_parallel_radian / 2) /
				pow((1.0 - es_sin) / (1.0 + es_sin), (ellipsoid->eccentricity / 2.0));
	...
	if (fabs(lcc->lcc_first_std_parallel_radian - lcc->lcc_second_std_parallel_radian) > 1.0e-10)
	{
		...
		double t2 = tan(PI_OVER_4 - lcc->lcc_second_std_parallel_radian / 2) /
					pow((1.0 - es_sin) / (1.0 + es_sin), (ellipsoid->eccentricity / 2.0));
...
{
	GeoProjectionParametersTM* tm =
		(GeoProjectionParametersTM*)(source ? source_projection : target_projection);

	if (!tm || tm->type != GEO_PROJECTION_TM)
		return;

	double tn = (ellipsoid->equatorial_radius - ellipsoid->polar_radius) /
				(ellipsoid->equatorial_radius + ellipsoid->polar_radius);
	double tn2 = tn * tn;
	double tn3 = tn2 * tn;
	double tn4 = tn3 * tn;
	double tn5 = tn4 * tn;

	tm->tm_ap = ellipsoid->equatorial_radius *
				(1.e0 - tn + 5.e0 * (tn2 - tn3) / 4.e0 + 81.e0 * (tn4 - tn5) / 64.e0);
	tm->tm_bp = 3.e0 * ellipsoid->equatorial_radius *
				(tn - tn2 + 7.e0 * (tn3 - tn4) / 8.e0 + 55.e0 * tn5 / 64.e0) / 2.e0;
	tm->tm_cp =
		15.e0 * ellipsoid->equatorial_radius * (tn2 - tn3 + 3.e0 * (tn4 - tn5) / 4.e0) / 16.0;
...
{
	GeoProjectionParametersAEAC* aeac =
		(GeoProjectionParametersAEAC*)(source ? source_projection : target_projection);

	if (!aeac || aeac->type != GEO_PROJECTION_AEAC)
		return;
	...
	double q0 = aeac->aeac_one_MINUS_es2 *
				(sin_lat / (one_MINUS_SQRes_sin) -
				 (1.0 / aeac->aeac_two_es) * log((1.0 - es_sin) / (1.0 + es_sin)));
	...
	double q1 = aeac->aeac_one_MINUS_es2 *
				(sin_lat_1 / (one_MINUS_SQRes_sin) -
				 (1.0 / aeac->aeac_two_es) * log((1.0 - es_sin) / (1.0 + es_sin)));

	double SQRm1 = m1 * m1;
	if (fabs(aeac->aeac_first_std_parallel_radian - aeac->aeac_second_std_parallel_radian) >
		1.0e-10)
	{
		...
		double q2 = aeac->aeac_one_MINUS_es2 *
					(sin_lat / (one_MINUS_SQRes_sin) -
					 (1.0 / aeac->aeac_two_es) * log((1.0 - es_sin) / (1.0 + es_sin)));
...
{
	GeoProjectionParametersHOM* hom =
		(GeoProjectionParametersHOM*)(source ? source_projection : target_projection);

	if (!hom || hom->type != GEO_PROJECTION_HOM)
		return;

	double esp = ellipsoid->eccentricity * sin(hom->hom_latitude_of_center_radian);
	double esp2 = esp * esp;
	hom->hom_B = sqrt(1.0 + ellipsoid->eccentricity_squared *
								pow(cos(hom->hom_latitude_of_center_radian), 4) /
								(1.0 - ellipsoid->eccentricity_squared));
	hom->hom_A = ellipsoid->equatorial_radius * hom->hom_B * hom->hom_scale_factor *
				 sqrt(1.0 - ellipsoid->eccentricity_squared) / (1.0 - esp2);
	double t = tan(PI / 4 - hom->hom_latitude_of_center_radian / 2) /
			   pow((1.0 - esp) / (1.0 + esp), ellipsoid->eccentricity / 2);
	double t0 = (t < 0 ? 0 : t);
	double D = hom->hom_B * sqrt(1.0 - ellipsoid->eccentricity_squared) /
			   cos(hom->hom_latitude_of_center_radian) / sqrt(1.0 - esp2);
	double F, D2;
	if (D < 1.0)
	{
		D2 = 1.0;
...
static double srat(double esinp, double exp) { return pow((1.0 - esinp) / (1.0 + esinp), exp); }

void GeoProjectionConverter::compute_os_parameters(bool source)
{
	GeoProjectionParametersOS* os =
		(GeoProjectionParametersOS*)(source ? source_projection : target_projection);

	if (!os || os->type != GEO_PROJECTION_OS)
		return;
	...
	os->os_R2 = 2.0 * sqrt(1.0 - ellipsoid->eccentricity_squared) /
				(1.0 - ellipsoid->eccentricity_squared * sphi * sphi);
	os->os_C = sqrt(1.0 + ellipsoid->eccentricity_squared * cphi * cphi /
							  (1.0 - ellipsoid->eccentricity_squared));
	...
	os->os_K = tan(0.5 * os->os_phic0 + PI / 4) /
			   (pow(tan(0.5 * os->os_lat_origin_radian + PI / 4), os->os_C) *
				srat(ellipsoid->eccentricity * sphi, os->os_ratexp));
...
bool GeoProjectionConverter::UTMtoLL(const double UTMEastingMeter,
									 ...
									 const GeoProjectionParametersUTM* utm) const
{
	...
	double mu = M / (ellipsoid->equatorial_radius *
					 (1 - ellipsoid->eccentricity_squared / 4 -
					  3 * ellipsoid->eccentricity_squared * ellipsoid->eccentricity_squared / 64 -
					  5 * ellipsoid->eccentricity_squared * ellipsoid->eccentricity_squared *
						  ellipsoid->eccentricity_squared / 256));

	double phi1Rad = mu +
					 (3 * ellipsoid->eccentricity_e1 / 2 - 27 * ellipsoid->eccentricity_e1 *
															   ellipsoid->eccentricity_e1 *
															   ellipsoid->eccentricity_e1 / 32) *
						 sin(2 * mu) +
					 (21 * ellipsoid->eccentricity_e1 * ellipsoid->eccentricity_e1 / 16 -
					  55 * ellipsoid->eccentricity_e1 * ellipsoid->eccentricity_e1 *
						  ellipsoid->eccentricity_e1 * ellipsoid->eccentricity_e1 / 32) *
						 sin(4 * mu) +
					 (151 * ellipsoid->eccentricity_e1 * ellipsoid->eccentricity_e1 *
					  ellipsoid->eccentricity_e1 / 96) *
						 sin(6 * mu);

	double N1 = ellipsoid->equatorial_radius /
				sqrt(1 - ellipsoid->eccentricity_squared * sin(phi1Rad) * sin(phi1Rad));
	...
	LatDegree =
		...
		(N1 * tan(phi1Rad) / R1) *
			(D * D / 2 -
			 (5 + 3 * T1 + 10 * C1 - 4 * C1 * C1 - 9 * ellipsoid->eccentricity_prime_squared) * D *
				 D * D * D / 24 +
			 (61 + 90 * T1 + 298 * C1 + 45 * T1 * T1 - 252 * ellipsoid->eccentricity_prime_squared -
			  3 * C1 * C1) *
				 D * D * D * D * D * D / 720);
	LatDegree = LatDegree * rad2deg;

	LongDegree = (D - (1 + 2 * T1 + C1) * D * D * D / 6 +
				  (5 - 2 * C1 + 28 * T1 - 3 * C1 * C1 + 8 * ellipsoid->eccentricity_prime_squared +
				   24 * T1 * T1) *
					  D * D * D * D * D / 120) /
				 cos(phi1Rad);
...
bool GeoProjectionConverter::compute_utm_zone(const double LatDegree,
											  const double LongDegree,
											  GeoProjectionParametersUTM* utm) const
{
	// Make sure the longitude is between -180.00 .. 179.9
	double LongTemp =
		(LongDegree + 180) - int((LongDegree + 180) / 360) * 360 - 180; // -180.00 .. 179.9;
	...
	utm->utm_long_origin =
		(utm->utm_zone_number - 1) * 6 - 180 + 3; // + 3 puts origin in middle of zone
...
bool GeoProjectionConverter::LLtoUTM(const double LatDegree,
									 const double LongDegree,
									 ...
									 const GeoProjectionParametersUTM* utm) const
{
	...
	double LongOriginRad =
		((utm->utm_zone_number - 1) * 6 - 180 + 3) * deg2rad; // + 3 puts origin in middle of zone

	double N = ellipsoid->equatorial_radius /
			   sqrt(1 - ellipsoid->eccentricity_squared * sin(LatRad) * sin(LatRad));
	...
	double M = ellipsoid->equatorial_radius *
			   ((1 - ellipsoid->eccentricity_squared / 4 -
				 ...
				 5 * ellipsoid->eccentricity_squared * ellipsoid->eccentricity_squared *
					 ellipsoid->eccentricity_squared / 256) *
					LatRad -
				(3 * ellipsoid->eccentricity_squared / 8 +
				 3 * ellipsoid->eccentricity_squared * ellipsoid->eccentricity_squared / 32 +
				 45 * ellipsoid->eccentricity_squared * ellipsoid->eccentricity_squared *
					 ellipsoid->eccentricity_squared / 1024) *
					sin(2 * LatRad) +
				(15 * ellipsoid->eccentricity_squared * ellipsoid->eccentricity_squared / 256 +
				 45 * ellipsoid->eccentricity_squared * ellipsoid->eccentricity_squared *
					 ellipsoid->eccentricity_squared / 1024) *
					sin(4 * LatRad) -
				(35 * ellipsoid->eccentricity_squared * ellipsoid->eccentricity_squared *
				 ellipsoid->eccentricity_squared / 3072) *
					sin(6 * LatRad));

	UTMEastingMeter =
		(double)(k0 * N *
					 (A + (1 - T + C) * A * A * A / 6 +
					  (5 - 18 * T + T * T + 72 * C - 58 * ellipsoid->eccentricity_prime_squared) *
						  A * A * A * A * A / 120) +
				 500000.0);
	...
	UTMNorthingMeter =
		(double)(k0 * (M + N * tan(LatRad) *
							   (A * A / 2 + (5 - T + 9 * C + 4 * C * C) * A * A * A * A / 24 +
								(61 - 58 * T + T * T + 600 * C -
								 330 * ellipsoid->eccentricity_prime_squared) *
									A * A * A * A * A * A / 720)));
			...
			double& LongDegree)
{
	...
	double t1 =
		tan(PI_OVER_4 - (phi1 / 2)) / pow(((1 - e * sin(phi1)) / (1 + e * sin(phi1))), e / 2);
	double t2 =
		tan(PI_OVER_4 - (phi2 / 2)) / pow(((1 - e * sin(phi2)) / (1 + e * sin(phi2))), e / 2);
	double to =
		tan(PI_OVER_4 - (phio / 2)) / pow(((1 - e * sin(phio)) / (1 + e * sin(phio))), e / 2);
 ...
 */
bool GeoProjectionConverter::LCCtoLL(const double LCCEastingMeter,
 ...
 * adapted from code by Garrett Potts ((C) 2000 ImageLinks Inc.)
 */
bool GeoProjectionConverter::LLtoLCC(const double LatDegree,
									 const double LongDegree,
									 ...
									 const GeoProjectionParametersLCC* lcc) const
{
	...
	*/
	...
	if (fabs(fabs(Latitude) - PI_OVER_2) > 1.0e-10)
	{
		...
		double t = tan(PI_OVER_4 - Latitude / 2) /
				   pow((1.0 - es_sin) / (1.0 + es_sin), ellipsoid->eccentricity / 2);
...
#define SPHSN(Latitude)                                                                            \
	((double)(ellipsoid->equatorial_radius /                                                       \
			  sqrt(1.e0 - ellipsoid->eccentricity_squared * pow(sin(Latitude), 2))))

#define SPHTMD(Latitude)                                                                           \
	((double)(tm->tm_ap * Latitude - tm->tm_bp * sin(2.e0 * Latitude) +                            \
			  tm->tm_cp * sin(4.e0 * Latitude) - tm->tm_dp * sin(6.e0 * Latitude) +                \
			  tm->tm_ep * sin(8.e0 * Latitude)))

#define DENOM(Latitude)                                                                            \
	((double)(sqrt(1.e0 - ellipsoid->eccentricity_squared * pow(sin(Latitude), 2))))
#define SPHSR(Latitude)                                                                            \
	((double)(ellipsoid->equatorial_radius * (1.e0 - ellipsoid->eccentricity_squared) /            \
 ...
 * adapted from code by Garrett Potts ((C) 2000 ImageLinks Inc.)
 */
bool GeoProjectionConverter::LLtoTM(const double LatDegree,
									const double LongDegree,
									...
									const GeoProjectionParametersTM* tm) const
{
	...
	t4 = sn * s * c5 * tm->tm_scale_factor *
		 (61.e0 - 58.e0 * tan2 + tan4 + 270.e0 * eta - 330.e0 * tan2 * eta + 445.e0 * eta2 +
		  324.e0 * eta3 - 680.e0 * tan2 * eta2 + 88.e0 * eta4 - 600.e0 * tan2 * eta3 -
		  192.e0 * tan2 * eta4) /
		 720.e0;

	t5 = sn * s * c7 * tm->tm_scale_factor * (1385.e0 - 3111.e0 * tan2 + 543.e0 * tan4 - tan6) /
		 40320.e0;

	TMNorthingMeter = tm->tm_false_northing_meter + t1 + pow(dlam, 2.e0) * t2 +
					  pow(dlam, 4.e0) * t3 + pow(dlam, 6.e0) * t4 + pow(dlam, 8.e0) * t5;

	/* Easting */
	t6 = sn * c * tm->tm_scale_factor;
	t7 = sn * c3 * tm->tm_scale_factor * (1.e0 - tan2 + eta) / 6.e0;
	t8 = sn * c5 * tm->tm_scale_factor *
		 (5.e0 - 18.e0 * tan2 + tan4 + 14.e0 * eta - 58.e0 * tan2 * eta + 13.e0 * eta2 +
		  4.e0 * eta3 - 64.e0 * tan2 * eta2 - 24.e0 * tan2 * eta3) /
		 120.e0;
	t9 = sn * c7 * tm->tm_scale_factor * (61.e0 - 479.e0 * tan2 + 179.e0 * tan4 - tan6) / 5040.e0;

	TMEastingMeter = tm->tm_false_easting_meter + dlam * t6 + pow(dlam, 3.e0) * t7 +
 ...
 * adapted from code by Garrett Potts ((C) 2000 ImageLinks Inc.)
 */
bool GeoProjectionConverter::TMtoLL(const double TMEastingMeter,
									...
									const GeoProjectionParametersTM* tm) const
{
	...
	t11 = t * (5.e0 + 3.e0 * tan2 + eta - 4.e0 * pow(eta, 2) - 9.e0 * tan2 * eta) /
		  (24.e0 * sr * pow(sn, 3) * pow(tm->tm_scale_factor, 4));
	t12 = t *
		  (61.e0 + 90.e0 * tan2 + 46.e0 * eta + 45.E0 * tan4 - 252.e0 * tan2 * eta - 3.e0 * eta2 +
		   100.e0 * eta3 - 66.e0 * tan2 * eta2 - 90.e0 * tan4 * eta + 88.e0 * eta4 +
	...
	t13 = t * (1385.e0 + 3633.e0 * tan2 + 4095.e0 * tan4 + 1575.e0 * pow(t, 6)) /
		  (40320.e0 * sr * pow(sn, 7) * pow(tm->tm_scale_factor, 8));
	...
	t16 = (5.e0 + 6.e0 * eta + 28.e0 * tan2 - 3.e0 * eta2 + 8.e0 * tan2 * eta + 24.e0 * tan4 -
		   4.e0 * eta3 + 4.e0 * tan2 * eta2 + 24.e0 * tan2 * eta3) /
		  (120.e0 * pow(sn, 5) * c * pow(tm->tm_scale_factor, 5));

	t17 = (61.e0 + 662.e0 * tan2 + 1320.e0 * tan4 + 720.e0 * pow(t, 6)) /
		  (5040.e0 * pow(sn, 7) * c * pow(tm->tm_scale_factor, 7));
 ...
 */
bool GeoProjectionConverter::ECEFtoLL(const double ECEFMeterX,
 ...
 */
bool GeoProjectionConverter::LLtoECEF(const double LatDegree,
									  const double LongDegree,
 ...
 */
bool GeoProjectionConverter::AEACtoLL(const double AEACEastingMeter,
									  ...
									  const GeoProjectionParametersAEAC* aeac) const
{
	...
	q = (aeac->aeac_C -
		 (rho_n * rho_n) / (ellipsoid->equatorial_radius * ellipsoid->equatorial_radius)) /
		aeac->aeac_n;
	qconst = 1.0 - ((aeac->aeac_one_MINUS_es2) / (aeac->aeac_two_es)) *
					   log((1.0 - ellipsoid->eccentricity) / (1.0 + ellipsoid->eccentricity));
 ...
 * adapted from ALBERS code of U.S. Army Topographic Engineering Center
 */
bool GeoProjectionConverter::LLtoAEAC(const double LatDegree,
									  const double LongDegree,
 ...
 */
bool GeoProjectionConverter::HOMtoLL(const double HOMEastingMeter,
...
{
	double v = (HOMEastingMeter - hom->hom_false_easting_meter) *
				   cos(hom->hom_rectified_grid_angle_radian) -
			   (HOMNorthingMeter - hom->hom_false_northing_meter) *
				   sin(hom->hom_rectified_grid_angle_radian);
	double u = (HOMNorthingMeter - hom->hom_false_northing_meter) *
				   cos(hom->hom_rectified_grid_angle_radian) +
			   (HOMEastingMeter - hom->hom_false_easting_meter) *
				   sin(hom->hom_rectified_grid_angle_radian);
	...
	double LongRadian = hom->hom_l0 - atan2(Sp * cos(hom->hom_g0) - Vp * sin(hom->hom_g0),
											cos(hom->hom_B * u / hom->hom_A)) /
										  hom->hom_B;
 ...
 * Formulas: OGP 373-7-2 Geomatics Guidance Note 7, part 2, July 2012
 */
bool GeoProjectionConverter::LLtoHOM(const double LatDegree,
									 const double LongDegree,
									 double& OMEastingMeter,
									 double& OMNorthingMeter,
									 const GeoProjectionEllipsoid* ellipsoid,
									 const GeoProjectionParametersHOM* hom) const
{
	...
	*/
	...
	double t = tan(PI / 4 - lat / 2) / pow((1.0 - ellipsoid->eccentricity * sin(lat)) /
											   (1 + ellipsoid->eccentricity * sin(lat)),
	...
	double u = hom->hom_A *
			   atan((S * cos(hom->hom_g0) + V * sin(hom->hom_g0)) /
					cos(hom->hom_B * (lon - hom->hom_l0))) /
			   hom->hom_B;
	OMEastingMeter = v * cos(hom->hom_rectified_grid_angle_radian) +
					 u * sin(hom->hom_rectified_grid_angle_radian) + hom->hom_false_easting_meter;
	OMNorthingMeter = u * cos(hom->hom_rectified_grid_angle_radian) -
					  v * sin(hom->hom_rectified_grid_angle_radian) + hom->hom_false_northing_meter;
	return true;
}
 ...
 */
bool GeoProjectionConverter::OStoLL(const double OSEastingMeter,
									...
									const GeoProjectionParametersOS* os) const
{
	...
	for (int i = 15;;)
	{
		double phi = 2.0 * atan(num * srat(ellipsoid->eccentricity * sin(y),
										   -0.5 * ellipsoid->eccentricity)) -
					 PI / 2;
 ...
 * formulas from "Oblique Stereographic Alternative" by Gerald Evenden and Rueben Schulz
 */
bool GeoProjectionConverter::LLtoOS(const double LatDegree,
									const double LongDegree,
									...
									const GeoProjectionParametersOS* os) const
{
	...
	y = 2.0 * atan(os->os_K * pow(tan(0.5 * y + PI / 4), os->os_C) *
				   srat(ellipsoid->eccentricity * sin(y), os->os_ratexp)) -
		PI / 2;
	x *= os->os_C;
	double sinc = sin(y);
	double cosc = cos(y);
...
bool GeoProjectionConverter::parse(int argc, char* argv[])
{
	...
	for (i = 1; i < argc; i++)
	{
		...
		else if (strcmp(argv[i], "-ellipsoid") == 0)
		{
			...
			{
				fprintf(stderr,
						"ERROR: ellipsoid with id %d is unknown. use one of those: \n",
						ellipsoid_id);
				ellipsoid_id = 1;
		...
		else if (strcmp(argv[i], "-wgs84") == 0)
		{
			...
			if (verbose)
				fprintf(stderr,
						"using datum '%s' with ellipsoid '%s'\n",
						tmp,
						get_ellipsoid_name());
			*argv[i] = '\0';
		}
		...
		else if (strncmp(argv[i], "-vertical_", 10) == 0)
		{
			if (strncmp(argv[i], "-vertical_navd88", 16) == 0)
			{
				...
				{
					fprintf(stderr,
							"WARNING: unknown specialization of NAVD88 '%s'\n",
							argv[i] + 16);
				}
				*argv[i] = '\0';
			}
			...
			else if (strcmp(argv[i], "-vertical_ngvd29") == 0 ||
					 strcmp(argv[i], "-vertical_navd29") == 0)
			{
				vertical_geokey = GEO_VERTICAL_NGVD29;
				*argv[i] = '\0';
			}
			...
			else if (strcmp(argv[i], "-vertical_epsg") == 0)
			{
				...
				if (sscanf(argv[i + 1], "%u", &code) != 1)
				{
					fprintf(
						stderr,
						"ERROR: '%s' needs 1 argument: EPSG code but '%s' is not a valid code\n",
						argv[i],
						argv[i + 1]);
					return false;
				}
				...
				{
					fprintf(stderr,
							"ERROR: '%s' needs 1 argument: EPSG code but %u is not a valid code\n",
							argv[i],
							code);
					return false;
				}
				...
				{
					fprintf(stderr,
							"ERROR: unknown vertical EPSG code in '%s %s'.\n",
							argv[i],
							argv[i + 1]);
					return false;
				}
				...
				{
					if (verbose)
						fprintf(stderr, "using vertical EPSG code %d\n", code);
				}
				*argv[i] = '\0';
				*argv[i + 1] = '\0';
				i += 1;
		...
		else if (strcmp(argv[i], "-utm") == 0 || strcmp(argv[i], "-target_utm") == 0)
		{
			...
			else
			{
				...
				{
					fprintf(stderr,
							"ERROR: utm zone '%s' is unknown. use '32north', '55south', '10n', "
							"'56s', '17U', or '49L'\n",
							argv[i + 1]);
					return false;
				}
		...
		else if (strcmp(argv[i], "-lcc") == 0 || strcmp(argv[i], "-target_lcc") == 0)
		{
			...
			{
				set_coordinates_in_survey_feet(source);
				// the definition of the projection was in survey feet but we always calculate in
				// meters
			...
			{
				fprintf(stderr,
						"ERROR: wrong options for '-lcc'. use like shown in these examples:\n");
				fprintf(stderr, "  %s 609601.22 0 meter 33.75 -79 34.33333 36.16666\n", argv[i]);
				fprintf(stderr,
						"  %s 1640416.666667 0 survey_feet 47.000000 -120.833333 47.5 48.733333\n",
						argv[i]);
				fprintf(stderr,
						"  %s 1500000 0 feet 47.000000 -120.833333 47.5 48.733333\n",
						argv[i]);
				return false;
			}
			...
			set_lambert_conformal_conic_projection(falseEasting,
												   falseNorthing,
												   latOfOriginDeg,
												   longOfOriginDeg,
												   firstStdParallelDeg,
		...
		else if (strcmp(argv[i], "-sp83") == 0 || strcmp(argv[i], "-target_sp83") == 0)
		{
			...
			if (set_state_plane_nad83_lcc(argv[i + 1], tmp, source))
			{
				if (verbose)
					fprintf(stderr,
							"using %s '%s' (NAD83 LCC) '%s'\n",
							(source ? "state plane" : "target state plane"),
							argv[i + 1],
							tmp);
			}
		...
		else if (strcmp(argv[i], "-tm") == 0 || strcmp(argv[i], "-transverse_mercator") == 0 ||
				 strcmp(argv[i], "-target_tm") == 0)
		{
			bool source =
				(strcmp(argv[i], "-tm") == 0 || strcmp(argv[i], "-transverse_mercator") == 0);
			double falseEasting;
			sscanf(argv[i + 1], "%lf", &falseEasting);
			double falseNorthing;
			sscanf(argv[i + 2], "%lf", &falseNorthing);
			...
			{
				fprintf(stderr,
						"ERROR: wrong options for '%s'. use like shown in these examples:\n",
						argv[i]);
				fprintf(stderr, "  %s 500000 0 meter 0 -93 0.99996\n", argv[i]);
				fprintf(stderr, "  %s 1500000 0 feet 47 -120.833333 0.99996\n", argv[i]);
				fprintf(stderr,
						"  %s 1640416.666667 0 survey_feet 47 -120.833333 0.99996\n",
						argv[i]);
				return false;
			}
			double latOriginDeg;
			...
			set_transverse_mercator_projection(falseEasting,
											   falseNorthing,
											   latOriginDeg,
											   longMeridianDeg,
											   scaleFactor,
		...
		else if (strcmp(argv[i], "-aeac") == 0 || strcmp(argv[i], "-target_aeac") == 0)
		{
			...
			{
				fprintf(stderr,
						"ERROR: wrong options for '-aeac'. use like shown in these examples:\n");
				fprintf(stderr, "  %s 609601.22 0 meter 33.75 -79 34.33333 36.16666\n", argv[i]);
				fprintf(stderr,
						"  %s 1640416.666667 0 survey_feet 47.000000 -120.833333 47.5 48.733333\n",
						argv[i]);
			...
			double firstStdParallelDeg = atof(argv[i + 6]);
			double secondStdParallelDeg = atof(argv[i + 7]);
			set_albers_equal_area_conic_projection(falseEasting,
												   falseNorthing,
												   latOfCenterDeg,
												   longOfCenterDeg,
												   firstStdParallelDeg,
		...
		else if (strcmp(argv[i], "-target_surveyfeet") == 0 ||
				 strcmp(argv[i], "-target_survey_feet") == 0)
		{
		...
		else if (strcmp(argv[i], "-elevation_surveyfeet") == 0 ||
				 strcmp(argv[i], "-elevation_survey_feet") == 0)
		{
			set_elevation_in_survey_feet();
			*argv[i] = '\0';
		}
		else if (strcmp(argv[i], "-target_elevation_surveyfeet") == 0 ||
				 strcmp(argv[i], "-target_elevation_survey_feet") == 0)
		{
...
int GeoProjectionConverter::unparse(char* string) const
{
	...
	if (target_projection != 0)
	{
		...
		else if (target_projection->type == GEO_PROJECTION_UTM)
		{
			...
			else
			{
				n += sprintf(&string[n],
							 "-target_utm %d%c ",
							 utm->utm_zone_number,
							 (utm->utm_northern_hemisphere ? 'N' : 'K'));
			}
		}
		else if (target_projection->type == GEO_PROJECTION_LCC)
		{
			...
			n += sprintf(&string[n],
						 "-target_lcc %lf %lf m %lf %lf %lf %lf ",
						 lcc->lcc_false_easting_meter,
						 lcc->lcc_false_northing_meter,
						 lcc->lcc_lat_origin_degree,
						 lcc->lcc_long_meridian_degree,
		...
		else if (target_projection->type == GEO_PROJECTION_AEAC)
		{
			...
			n += sprintf(&string[n],
						 "-target_aeac %lf %lf m %lf %lf %lf %lf ",
						 aeac->aeac_false_easting_meter,
						 aeac->aeac_false_northing_meter,
						 aeac->aeac_latitude_of_center_degree,
						 aeac->aeac_longitude_of_center_degree,
																		   ...
																		   bool source) const
{
	...
	{
		if (source)
			return (coordinates2meter == 1.0
						? (abrev ? "m" : "meter")
						: (coordinates2meter == 0.3048 ? (abrev ? "ft" : "feet")
													   : (abrev ? "sft" : "surveyfeet")));
		else
			return (meter2coordinates == 1.0
						? (abrev ? "m" : "meter")
						: (meter2coordinates == 0.3048 ? (abrev ? "ft" : "feet")
													   : (abrev ? "sft" : "surveyfeet")));
	}
	else
	{
...
bool GeoProjectionConverter::to_lon_lat_ele(const double* point,
											double& longitude,
											double& latitude,
											double& elevation_in_meter) const
{
	if (source_projection)
	{
		...
		case GEO_PROJECTION_LCC:
			LCCtoLL(coordinates2meter * point[0],
					coordinates2meter * point[1],
					latitude,
					longitude,
					ellipsoid,
		...
		case GEO_PROJECTION_TM:
			TMtoLL(coordinates2meter * point[0],
				   coordinates2meter * point[1],
				   latitude,
				   longitude,
				   ellipsoid,
		...
		case GEO_PROJECTION_ECEF:
			ECEFtoLL(coordinates2meter * point[0],
					 coordinates2meter * point[1],
					 coordinates2meter * point[2],
					 latitude,
					 longitude,
					 elevation_in_meter,
					 ellipsoid);
		...
		case GEO_PROJECTION_AEAC:
			AEACtoLL(coordinates2meter * point[0],
					 coordinates2meter * point[1],
					 latitude,
					 longitude,
					 ellipsoid,
		...
		case GEO_PROJECTION_OS:
			OStoLL(coordinates2meter * point[0],
				   coordinates2meter * point[1],
				   latitude,
				   longitude,
				   ellipsoid,
		...
		case GEO_PROJECTION_HOM:
			HOMtoLL(coordinates2meter * point[0],
					coordinates2meter * point[1],
					latitude,
					longitude,
					ellipsoid,
...
bool GeoProjectionConverter::check_horizontal_datum_before_reprojection()
{
	if (source_projection && target_projection)
	{
		...
		{
			//      fprintf(stderr, "WARNING: horizontal datum of target unspecified. assuming same
			//      as source.\n");
...
bool GeoProjectionConverter::to_target(const double* point,
									   double& x,
									   double& y,
									   double& elevation) const
{
	if (source_projection && target_projection)
	{
		...
		{
		case GEO_PROJECTION_UTM:
			UTMtoLL(coordinates2meter * point[0],
					coordinates2meter * point[1],
					latitude,
					longitude,
					ellipsoid,
		...
		case GEO_PROJECTION_UTM:
			if (((GeoProjectionParametersUTM*)target_projection)->utm_zone_number == -1)
				compute_utm_zone(latitude,
								 longitude,
								 (GeoProjectionParametersUTM*)target_projection);
			LLtoUTM(latitude,
					longitude,
					x,
					y,
					ellipsoid,
					(const GeoProjectionParametersUTM*)target_projection);
		...
		case GEO_PROJECTION_LCC:
			LLtoLCC(latitude,
					...
					y,
					ellipsoid,
					(const GeoProjectionParametersLCC*)target_projection);
			x = meter2coordinates * x;
			y = meter2coordinates * y;
			break;
		case GEO_PROJECTION_TM:
			LLtoTM(latitude,
				   ...
				   y,
				   ellipsoid,
				   (const GeoProjectionParametersTM*)target_projection);
			x = meter2coordinates * x;
			y = meter2coordinates * y;
			break;
		case GEO_PROJECTION_LONG_LAT:
		...
		case GEO_PROJECTION_AEAC:
			LLtoAEAC(latitude,
					 ...
					 y,
					 ellipsoid,
					 (const GeoProjectionParametersAEAC*)target_projection);
			x = meter2coordinates * x;
			y = meter2coordinates * y;
			break;
		case GEO_PROJECTION_OS:
			LLtoOS(latitude,
				   ...
				   y,
				   ellipsoid,
				   (const GeoProjectionParametersOS*)target_projection);
			x = meter2coordinates * x;
			y = meter2coordinates * y;
			break;
		case GEO_PROJECTION_HOM:
			LLtoHOM(latitude,
					...
					y,
					ellipsoid,
					(const GeoProjectionParametersHOM*)target_projection);
			x = meter2coordinates * x;
			y = meter2coordinates * y;
			break;
		}
...
/*
bool GeoProjectionConverter::get_img_datum_parameters(char** psDatumame, int* proNumber, int*
proZone, double** proParams,) const
{
  if (ellipsoid)
  {
	if (ellipsoid->id == GEO_ELLIPSOID_WGS84)
	  ...
	  *psDatumame = LASCopyString("NAD27");
		...
		else if (ellipsoid->id == GEO_ELLIPSOID_NAD83)
		{
		  if (utm->utm_northern_hemisphere)
		  {
			...
			{
			  fprintf(stderr, "get_ProjectedCSTypeGeoKey: northern UTM zone %d for NAD83
out-of-range\n", utm->utm_zone_number);
			}
		  }
		  else
		  {
			fprintf(stderr, "get_ProjectedCSTypeGeoKey: southern UTM zone %d for NAD83 does not
exist\n", utm->utm_zone_number);
		  }
		}
		else if (ellipsoid->id == GEO_ELLIPSOID_CLARKE1866)
		{
		  if (utm->utm_northern_hemisphere)
		  {
			...
			{
			  fprintf(stderr, "get_ProjectedCSTypeGeoKey: northern UTM zone %d for NAD27
out-of-range\n", utm->utm_zone_number);
			}
		  }
		  else
		  {
			fprintf(stderr, "get_ProjectedCSTypeGeoKey: southern UTM zone %d for NAD27 does not
exist\n", utm->utm_zone_number);
		  }
		}
		else if (ellipsoid->id == GEO_ELLIPSOID_GRS1967)
		{
		  if (utm->utm_northern_hemisphere)
		  {
			...
			{
			  fprintf(stderr, "get_ProjectedCSTypeGeoKey: northern UTM zone %d for SAD69
out-of-range\n", utm->utm_zone_number);
			}
		  }
		  else
		  {
			...
			{
			  fprintf(stderr, "get_ProjectedCSTypeGeoKey: southern UTM zone %d for SAD69
out-of-range\n", utm->utm_zone_number);
			}
		  }
		}
		else if (ellipsoid->id == GEO_ELLIPSOID_INTERNATIONAL)
		{
		  if (utm->utm_northern_hemisphere)
		  {
			...
			{
			  fprintf(stderr, "get_ProjectedCSTypeGeoKey: northern UTM zone %d for ED50
out-of-range\n", utm->utm_zone_number);
			}
		  }
		  else
		  {
			fprintf(stderr, "get_ProjectedCSTypeGeoKey: southern UTM zone %d for ED50 does not
exist\n", utm->utm_zone_number);
		  }
		}
		else if (ellipsoid->id == GEO_ELLIPSOID_ID74)
		{
		  if (utm->utm_northern_hemisphere)
		  {
			...
			{
			  fprintf(stderr, "get_ProjectedCSTypeGeoKey: northern UTM zone %d for ID74
out-of-range\n", utm->utm_zone_number);
			}
		  }
		  else
		  {
			...
			{
			  fprintf(stderr, "get_ProjectedCSTypeGeoKey: southern UTM zone %d for ID74
out-of-range\n", utm->utm_zone_number);
			}
		  }
		}
		...
		{
		  fprintf(stderr, "get_ProjectedCSTypeGeoKey: look-up for UTM zone %d and ellipsoid with id
...
bool GeoProjectionConverter::get_img_projection_parameters(char** proName, int* proNumber, int*
proZone, double** proParams,) const
{
  GeoProjectionParameters* projection = get_projection(source);
  if (projection)
  {
	...
	if (projection->type == projection->type == GEO_PROJECTION_LAT_LONG || projection->type ==
GEO_PROJECTION_LONG_LAT)
	{
	  *proNumber = 0;
	}
	else if (projection->type ==
...
bool GeoProjectionConverter::get_dtm_projection_parameters(short* horizontal_units,
			...
			*coordinate_system = 2;
			...
			if (utm->utm_northern_hemisphere)
				...
				*coordinate_zone = utm->utm_zone_number + 100;
				 ...
				 (projection->type == GEO_PROJECTION_TM))
		{
			unsigned short geokey = get_ProjectedCSTypeGeoKey(source);
			if ((geokey != 0) && (geokey != 32767))
			{
				...
				default:
					*coordinate_zone = 0;
					fprintf(stderr,
							"state plane with geotiff tag %d not implemented\n",
							(int)geokey);
				}
				if (*coordinate_zone)
				{
...
bool GeoProjectionConverter::set_dtm_projection_parameters(short horizontal_units,
														   short vertical_units,
														   short coordinate_system,
														   short coordinate_zone,
														   short horizontal_datum,
