...
public:
	...
	* @return
	*/
	static pc::data::tagPagedLodFile GetPagedLodModelPath(pc::data::CModelNodePtr pPointCloudPagedLod);
	...
	* 返回值  ：void
	*/
	static void GetEigenVectors(osg::Vec3d& outMajorPoint, osg::Vec3d& outMiddlePoint, osg::Vec3d& outMinorPoint, const std::vector<osg::Vec3d>& vPoints);
