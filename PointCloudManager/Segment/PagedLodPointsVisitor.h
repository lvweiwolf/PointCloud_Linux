...
protected:
	 ...
	 * @return
	 */
	void SetPointCloudIndividualClass(osg::ref_ptr<osg::Vec2Array> pTexCoordArray,
									  size_t texIndex,
	 ...
	 * @return
	 */
	void WriteTreeIndividual(const osg::Vec3& point,
	 ...
	 * @return
	 */
	void WriteSetSegment(const osg::Vec3& screenPoint,
						 osg::ref_ptr<osg::Vec2Array> pTexCoordArray,
						 size_t texIndex,
						 size_t pointCloudIndex);
	 ...
	 * @return
	 **/
	void ReadWriteNoBound(osg::ref_ptr<osg::Vec3Array>& vertArray,
						  osg::Matrix& matrix,
	 ...
	 * @return
	 */
	void WritePoint(osg::ref_ptr<osg::Vec3Array>& vertArray,
					osg::Matrix& matrix,
					osg::ref_ptr<osg::Vec2Array> pTexCoordArray);
	 ...
	 * @return
	 **/
	virtual void ReadWriteByBound(osg::Vec3& point,
								  osg::ref_ptr<osg::Vec2Array> pTexCoordArray,
								  const osg::Vec3d& boxCenter,
								  size_t i);
	 ...
	 * @return
	 */
	void CreateCluster(osg::ref_ptr<osg::Vec2Array> pTexCoordArray,
					   size_t nVertexIndex,
					   unsigned treeId,
...
{
	SClusterBoxMap(std::map<unsigned, osg::BoundingBox>& clusterBoxList)
		: _clusterBoxMap(clusterBoxList)
	{
	}
...
{
	SPointReadWriterParam()
		: _pLodNode(nullptr),
		  _nBeginIndex(0),
		  _eSegment(ESegmentType::eAutoSegment),
