...
//*****************************************************
#ifndef POINTCLOUDMANAGERDEFINE_H_
#define POINTCLOUDMANAGERDEFINE_H_
...
namespace pc {
	namespace data {
		struct PointInfo
		{
			PointInfo(void) : dX(0.0), dY(0.0), dZ(0.0), nTreeId(0), pointClassify(OTHER_CLASSIFY)
			{
			}
		...
		{
			{ eNoError, NULL }, { eOverMaxLimit, _T("查询的点云数量超过最大限制") }
		}
...
#endif // POINTCLOUDMANAGERDEFINE_H_